...
(async () => {
    ...
    const customData = [{
        ...
        reg: /^https?:\/\/((www\.)?wnacg\.com|www\.htmanga\d\.top|www\.hentaicomic\.ru|www\.wn3\.lol|www\.hm\d{1,2}\.lol)\/photos-index(-page-\d+)?-aid-\d+\.html/,
        init: async () => {
        ...
        reg: /^https?:\/\/(sixcomic\.com|sixacg\.com|www\.sixacg\.org|6acg\.top)\/chapter\/\d+$/,
