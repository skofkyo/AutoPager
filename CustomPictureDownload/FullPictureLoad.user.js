...
(async () => {
    ...
    const customData = [{
        ...
        imgs: () => {
            ...
            let xhrNum = 0;
            let getRes = [...fun.gae(".article-content img[src*='-285x285']")].map(e => e.src.replace("-285x285", "")).map(async (src, i, arr) => {
        ...
        name: "秀人美女網",
        host: ["www.xrmn01.com", "m.xrmn.xyz"],
        ...
        imgs: () => fun.getImg(".item-image img,#img-box img", (fun.geT("li.next-page", 2) || 1)),
        button: [4],
        insertImg: ["#img-box", 2],
        ...
        reg: /(hotgirlchina\.com|thechinagirls\.com|theasiagirl\.com|anhsec\.com|sex4viet\.com|cutexinh\.com|girlxinhxinh\.com|asiaceleb\.com|chinagirly\.com)\/.+(photos?|videos?|anh)?\/?|^https?:\/\/babeasia\.com\/\d+\/[^\/]+\/$/,
        ...
        init: () => {
            ...
            fun.run("$('.snips-image').unbind();$('.snips-image img').unbind();");
        },
        autoPager: {
            //mode: 1,
            ele: ".blog-posts",
        ...
        autoPager: {
            ...
            title: doc => doc.title.replace(" - Models Vibe", "").replace(/\s-\sPage\s\d+/, "") + ` - Page ${currentPageNum}`
        },
        ...
        name: "麻豆村/糖心vlog",
        host: ["madoucun.com", "tangxvlog.com"],
        link: "https://madoucun.com/arttype/57.html，https://tangxvlog.com/arttype/57.html",
        reg: /^https?:\/\/(madoucun\.com|tangxvlog\.com)\/artdetail-\d+\.html/,
        ...
        name: "中看图片大全/图片发达网/昆山美图网/桃子啦/漫爱美图/雾四图片网/屈求图库/闲人图片大全/天气图片大全/洒清图片网/宫戏图片网/有臣美图/MM美图网/克斯图片网/你给图库/质量美图网/茫茫图片库/黑丝MM图库/MM美图网/奇米美图777/几时图片网/夜寄图库/出卖图片库/所尚图片大全/80天堂图片网/玩偶图片网/立春美图/敢面美图/不论图片网/如之美图/抢暴美图/高空美图/我见图库",
        host: ["www.zkjmpx.com", "www.tufada.com", "www.ksxx365.com", "www.tzala.com", "www.mash120.com", "www.wslak.com", "www.777url.com", "www.xr70.com", "www.t7mm.com", "www.sqhyyz.com", "www.gxwpjc.com", "www.ycwlx.com", "www.ksxx360.com", "www.ngptp.com", "www.zlsmm.com", "www.mmdmlt.com", "www.hsnmm.com", "www.mmxsl.com", "www.i9ke.com", "www.jsjfgkgs.com", "www.yjpfxs.com", "www.cmylzx.com", "www.sskge.com", "www.iduobi.com", "www.woxiutu.com", "www.lcylaa.com", "www.gmcpx.com", "www.803352.com", "www.rzjyz.com", "www.cpbdj.com", "www.gkiev.com", "www.wjjlf.com"],
        reg: /^https?:\/\/www\.(zkjmpx|tufada|ksxx365|tzala|mash120|wslak|777url|xr70|t7mm|sqhyyz|gxwpjc|ycwlx|ksxx360|ngptp|zlsmm|mmdmlt|hsnmm|mmxsl|i9ke|jsjfgkgs|yjpfxs|cmylzx|sskge|iduobi|woxiutu|lcylaa|gmcpx|803352|rzjyz|cpbdj|gkiev|wjjlf)\.com\/\w+\/\d+\.html|^https?:\/\/www\.tufada\.com\/tu\d+\.html/,
        ...
        name: "禁漫天堂",
        host: ["18comic.vip", "18comic.org", "jmcomic.me", "jmcomic1.me", "jm-comic1.art", "jm-comic2.art", "jm-comic3.art"],
        reg: /^https?:\/\/(18comic.(vip|org)|jmcomic\d?\.me|jm-comic\d.art)\/photo\/\d+/,
        ...
        host: ["twhentai.com", "cn.hentai.desi"],
        reg: /^https?:\/\/(twhentai\.com|cn\.hentai\.desi)\/hentai_manga\/\d+\/$/,
        imgs: async () => {
        ...
        scrollEle: () => {
            fun.aotoScrollEles(".mh_comicpic", (ele) => fun.ge("img[src]", ele));
        },
        next: "//a[text()='下一章']",
        prev: "//a[text()='上一章']",
...
document.body.appendChild(text);
        ...
        scrollEle: () => {
            fun.aotoScrollEles(".img-content .content-img", (img) => /^blob/.test(img.src));
        },
    ...
    const fun = {
        ...
        fetchErrorMsg: () => {
            if (fetchErrorArray.length > 0) {
                debug(`\nfetchErrorArray\n`, fetchErrorArray);
                setTimeout(() => {
                    fun.showMsg(`${displayLanguage.str_97}${fetchErrorArray.length}${displayLanguage.str_98}`, 10000);
                }, 1500);
            }
        },
        ...
        arr: num => new Array(parseInt(num, 10)).fill(null),
        ...
        aotoScrollEles: async (selector, callback, time = 5000) => {
            ...
            if (imgs.length < newImgs.length) {
                ...
                autoScrollIntoView(newImgs, imgs.length + newImgs.length);
            }
        },
...
console.log("fancybox 3.5.7 選項物件",$.fancybox.defaults);
    ...
    if (hasTouchEvents() && showOptions || !autoDownload && showOptions) {
        [...gae("#FullPictureLoadOptionsAutoDownloadDIV,#FullPictureLoadOptionsCountdownDIV")].forEach(e => {
    ...
    _GM_registerMenuCommand(displayLanguage.str_66, () => {
