...
(async () => {
    ...
    const MobileUA = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Mobile Safari/537.36";
    ...
    const customData = [{
        ...
        reg: () => /\/htm_data\/\d+\/\d+\/\d+\.html$/.test(siteUrl) && fun.ge("img[ess-data]") ? true : false,
        imgs: "img[ess-data]",
        ...
        init: () => new MutationObserver(() => document.body.classList.remove("compensate-for-scrollbar")).observe(document.body, MutationObserverConfig),
        imgs: async () => {
            let arr = [];
            ...
            if (/\(\d+\)(-tic)?\./.test(url)) {
                ...
                try {
                    let [, path, fileName, ex] = url.match(/^(.+\/)([\w-]+)(\.[a-z]{3,4})$/i);
        ...
        reg: /www\.hitxhot\.org\/(gallerys|articles|photos)\/(?!\?page=|\?m=|hot|top|tag)\w+\.html(\?m=1)?$|^https?:\/\/hitxhot\.com\/blog\/\w+\.html(\?m=1)?$/i,
        imgs: async () => {
            let max;
            try {
        ...
        name: "www.depvailon.com crimejunkiespodcast.com pic.yailay.com nungvl.net www.kaizty.com lootiu.com depday.info thismore.fun cosxuxi.club",
        reg: /(pic\.yailay\.com|www\.kaizty\.com)\/(gallerys|articles|photos)\/(?!\?page=|\?m=|hot|top|tag)\w+\.html$|(www\.depvailon\.com|crimejunkiespodcast\.com)\/(?!\?page=|\?m=).+\.html$|nungvl\.net\/gallerys\/\d+\.cg$|lootiu\.com\/gallery\/.+\.cfg$|(pic\.yailay\.com|www\.kaizty\.com)\/(gallerys|articles|photos)\/(?!\?page=|\?m=|hot|top|tag)\w+\.html|www\.depvailon\.com\/(?!\?page=|\?m=).+\.html|nungvl\.net\/gallerys\/\d+\.cg|lootiu\.com\/gallery\/.+\.cfg|depday\.info\/v2\/\w+\.html|^https?:\/\/thismore\.fun\/view\/[^\.]+\.php|^https?:\/\/cosxuxi\.club\/[^\.]+\.html/i,
        imgs: async () => {
            let max;
            try {
        ...
        customTitle: () => fun.geT("h1").replace(/\|/g, "").replace(/(\s?-\s?)?\d+P/i, "").replace(/\[\d+[\w\s\.\+-]+\]/i, ""),
        category: "nsfw2"
    }, {
        ...
        imgs: () => {
            let max;
            try {
                max = fun.geT(".paging>li>a,.tags>li>a,.pre_next>li>a").match(/\d+/)[0];
            } catch (e) {
                max = 1;
            }
        ...
        name: "四海资讯/娱乐吧",
        host: ["www.shzx.org", "m.shzx.org", "www.yuleba.org", "m.entba.net"],
        link: "https://www.shzx.org/b/12-0.html",
        reg: /((www|m)\.shzx\.org|www\.yuleba\.org|m\.entba\.net)\/a\/[\d-]+\.html/,
        imgs: () => {
            let max;
            try {
        ...
        reg: () => /\/\w+\/\d+\.html$/.test(siteUrl) && fun.ge("//div[@class='item_info']//a[text()='秀人集']") ? true : false,
        init: () => {
        ...
        reg: () => /\/\w+\/\d+\/\d+\.html$/.test(siteUrl) && fun.ge("//div[@class='single-cat']/a[text()='秀人美女网']") ? true : false,
        imgs: () => fun.getImg('.content p img[alt]', fun.geT(".page a:last-child", 2), 3, [null, null], 200),
        button: [4],
        ...
        reg: () => /\/\w+\/\w+\.html$/.test(siteUrl) && fun.ge("//div[@class='toptip']/a[text()='极品性感美女']") ? true : false,
        init: () => {
        ...
        name: "爱看美女网",
        host: ["www.ikmn05.cc"],
        reg: () => /^https?:\/\/www\.ikmn(\d+)?\.\w+\/\w+\/\d+\.html$/.test(siteUrl) && fun.ge(".info-pagebar>a") ? true : false,
        init: () => {
        ...
        reg: () => /^https?:\/\/(www|m)\.kaka234\.cc\/HTM\/\w+\/(\w+\/)?\d+\/\d+\/\d+\.html$/.test(siteUrl) && fun.ge(".Title>h1,.PsBox") ? true : false,
        init: () => {
        ...
        imgs: () => {
            let max;
            try {
                max = fun.geT("//a[contains(text(),'共')]").match(/\d+/)[0];
            } catch (e) {
                max = 1;
            }
        ...
        reg: () => /^https?:\/\/k55\.net\/artdetail-\d+\.html/.test(siteUrl) && fun.ge(".photo_box") ? true : false,
        ...
        go: 1,
        customTitle: () => fun.geT(".entry-title").replace(/\[\d+[-\.\+\s\w]+\]/, "").trim(),
        category: "nsfw1"
    }, {
        name: "XLUST.ORG",
        host: ["xlust.org"],
        ...
        name: "8E资源站",
        host: ["8ezy.com"],
        reg: () => /^https?:\/\/8ezy\.com\/[^\/]+\/$/.test(siteUrl) && fun.ge(".entry-content") ? true : false,
        ...
        name: "8E资源站",
        host: ["8ezy.com"],
        reg: () => /^https?:\/\/8ezy\.com\//.test(siteUrl) && fun.ge(".infinite-scroll-button") ? true : false,
        //init: () => fun.clearAllTimer(),
        ...
        next: ".prev>a",
        prev: ".next>a",
        customTitle: () => fun.geT(".postTitle>h1"),
        ...
        imgs: () => fun.getImg(".image_div img", fun.geT(".item_info span"), 9, [null, null], 200),
        button: [4],
        ...
        name: "秀人图集",
        host: ["xiuren0.com"],
        reg: () => /xiuren\d\.com\/\d+\.html$/.test(siteUrl) && fun.ge(".article-paging>*:last-child") ? true : false,
        ...
        imgs: async () => fun.checkImageCDN(await fun.getImg(".article-fulltext img", fun.geT(".pagination-list>span:last-child"))),
        button: [4],
        ...
        reg: () => /^https?:\/\/www\.v2ph\.(com|net|ru|ovh)\/album\//.test(siteUrl) && !siteUrl.includes("?page=") && fun.ge(".photos-list") ? true : false,
        imgs: async () => {
        ...
        reg: () => /(www\.emonl\.com|www\.cybesx\.com)\/\d+\.html$/i.test(siteUrl) && fun.ge(".page-links") && !fun.ge(".read-point-box") ? true : false,
        ...
        name: "柠檬皮",
        host: ["www.emonl.com", "www.cybesx.com"],
        reg: () => /(www\.emonl\.com|www\.cybesx\.com)\/\d+\.html$/i.test(siteUrl) && fun.ge(".single-content img") && !fun.ge(".read-point-box") ? true : false,
        ...
        init: () => location.pathname.split("/").length == 3 ? currentPageNum = 1 : currentPageNum = parseInt(location.pathname.split("/").at(-1), 10),
        autoPager: {
            ele: ".headling_main_a",
        ...
        next: "span.prev>a",
        prev: "span.next>a",
        customTitle: () => fun.geT(".entry-title").replace(/\(\d+\s?Photos\)|\(\d+p\)|【\d+[\w\s\.\+-]+】/i, "").trim(),
        ...
        reg: () => /^https?:\/\/www\.888meinv\.com\/\w+\/\d+$/.test(siteUrl) && fun.ge(".suoyou") ? true : false,
        imgs: () => {
        ...
        reg: () => /^https?:\/\/www\.shunva?i\.com\/\w+\/\d+\.html$/.test(siteUrl) && fun.ge("#allnum") ? true : false,
        imgs: () => {
        ...
        customTitle: () => fun.geT(".picmainer>h1").replace(/\(\d+\/\d+\)/, ""),
        css: ".picpege{display:none!important;}",
        category: "nsfw1"
    }, {
        name: "淑女爱M",
        host: ["m.shunvi.com", "m.shunvai.com"],
        reg: () => /^https?:\/\/m\.shunva?i\.com\/photo\/\d+\.html$/.test(siteUrl) && fun.ge("#thenum") ? true : false,
        imgs: () => {
            let max = fun.geT("//span[b[@id='thenum']]").match(/\d+$/)[0];
            let links = fun.arr(max).map((_, i) => i == 0 ? siteUrl : siteUrl.replace(".html", "") + "_" + (i + 1) + ".html");
            return fun.getImgA(".swiper-slide img", links, 200);
        },
        button: [4],
        insertImg: ["#slider", 2],
        customTitle: () => fun.geT(".infoline").replace(/\d+\s\/\s\d+\n/, ""),
        category: "nsfw1"
    }, {
        name: "mn52图库",
        ...
        customTitle: () => fun.geT(".title>h1,.general-title>h4"),
        ...
        imgs: () => {
            let max = fun.geT(".title>span").match(/\d+$/)[0];
        ...
        next: "a.page-next",
        prev: "a.page-prev",
        customTitle: () => fun.geT(".pic-infobox h1"),
        ...
        name: "优美图库M",
        host: ["wap.umei.cc"],
        reg: () => /wap\.umei\.cc\/meinvtupian\/\w+\/\d+\.htm$/.test(siteUrl) && fun.ge("//a[text()='尾页']") ? true : false,
        imgs: () => {
        ...
        reg: () => /^https?:\/\/www\.costhisfox\.com\/\d+\/$/i.test(siteUrl) && fun.ge("//ul[@class='breadcrumb']//a[text()='cos福利美图']|//ul[@class='breadcrumb']//a[text()='写真系列']") ? true : false,
        imgs: ".wp-posts-content img[data-src]",
        button: [4],
        insertImg: [".wp-posts-content", 2],
        autoDownload: [0],
        next: "//a[p[text()='上一篇']]",
        prev: "//a[p[text()='下一篇']]",
        customTitle: () => fun.geT("h1.article-title").replace(/\d+P/i, "").trim(),
        fancybox: {
            blacklist: 1
        },
        css: "div[data-nav=posts][style]{max-height:unset!important}",
        ...
        name: "男人之家",
        host: "nanrenhome.cc",
        reg: () => /^https?:\/\/nanrenhome\.cc\/\d+\.html/.test(siteUrl) && fun.ge("//a[@rel='category tag'][text()='福利美图']") ? true : false,
        imgs: () => {
        ...
        name: "网红跟我俩",
        host: "www.2wh.net",
        reg: () => /^https?:\/\/www\.2wh\.net\/\d+\.html$/.test(siteUrl) && fun.ge("//div[@class='breadcrumbs']/a[2][text()='美女写真机构']") ? true : false,
        imgs: () => {
            let pag = fun.ge(".article-paging a[href]");
            return pag ? fun.getImgA(".article-content img", ".article-paging a[href]") : [...fun.gae(".article-content img")];
        },
        ...
        next: ".article-nav-prev a",
        prev: ".article-nav-next a",
        customTitle: () => fun.geT(".article-title").replace("无删减私房写真流出", "").replace(/\[\d+[\w\s\+-]+\]/, "").replace(/\(\d+[\w\s\+-]+\)/, ""),
        category: "nsfw1"
    }, {
        name: "网红跟我俩",
        ...
        next: ".article-nav-prev a",
        prev: ".article-nav-next a",
        customTitle: () => fun.geT(".article-title").replace("无删减私房写真流出", "").replace(/\[\d+[\w\s\+-]+\]/, ""),
        category: "nsfw1"
    }, {
        name: "男人社区",
        host: "xxk222.com",
        link: "https://xxk222.com/arttype/meinv.html",
        reg: () => /^https?:\/\/xxk222\.com\/artdetail\/\w+\.html/.test(siteUrl) && fun.ge("//strong[text()='美女美图']") ? true : false,
        imgs: async () => {
        ...
        customTitle: () => fun.geT(".single-video-title a").replace(/\[\d+p\]/i, ""),
        category: "nsfw2"
    }, {
        name: "RedBust",
        host: "redbust.com",
        reg: () => /redbust\.com\/[^\/]+\/$/.test(siteUrl) && fun.ge(".entry-inner img") ? true : false,
        imgs: () => {
        ...
        name: "E次元",
        host: ["www.evacg.org"],
        reg: () => /www\.evacg\.org\/archives\/\d+/.test(siteUrl) && fun.ge(".wp-caption img") && !fun.ge(".poi-alert__msg") ? true : false,
        imgs: ".wp-caption img",
        button: [4],
        insertImg: [
        ...
        reg: () => /^https?:\/\/cosplayporn\.online\/\w+\/[^\/]+\/$/.test(siteUrl) && fun.ge(".video-description img") && !fun.ge(".responsive-player") ? true : false,
        ...
        reg: () => /cosporn\.online\/.+\//.test(siteUrl) && fun.ge(".g1-content-narrow") ? true : false,
        imgs: () => {
            thumbnailsSrcArray = [...fun.gae(".g1-content-narrow img:not([id])")].map(e => e.dataset.lazySrc ?? e.src);
            return thumbnailsSrcArray.map(e => e.replace(/\?w=\d+&ssl=1/, ""));
        },
        button: [4],
        ...
        name: "街角图片社",
        host: ["ijjiao.com"],
        reg: () => /^https?:\/\/ijjiao\.com\/\d+\/\d+\/\d+\/album/.test(siteUrl) && fun.ge(".v-pagination") && !fun.ge("//span[text()='加载更多']") ? true : false,
        delay: 800,
        imgs: async () => {
        ...
        repeat: 1,
        button: [4],
        insertImg: ["#fullPictureLoadImgBox", 3],
        go: 1,
        observerTitle: true,
        downloadVideo: true,
        ...
        name: "秀窝/RMM吧/赞MM/恩图集/美Girl图集/狐图网/930圖片網/爱秀美女",
        host: ["www.xiuwo.net", "rmm8.com", "www.zanmm.com", "www.entuji.com", "www.mhgirl.com", "www.hutu6.com", "www.930tu.com", "www.930tp.com", "wap.kunv.cc"],
        reg: /(www\.xiuwo\.net|rmm8\.com|www\.mhgirl\.com|wap\.kunv\.cc)\/tu([\w]+)?\/\d+\.html|www\.zanmm\.com\/tupian\/\d+\.html|(www\.entuji\.com|www\.hutu6\.com)\/\w+\/\d+\.html|www\.930t(u|p)\.com\/\w+\/\d+\.html/,
        init: () => fun.clearAllTimer(),
        imgs: () => fun.getImgO("#showimg img", fun.geT("//p[contains(text(),'图片数量')]").match(/\d+/)[0], 9),
        button: [4],
        insertImg: ["#showimg", 2],
        ...
        name: "遛无写真/有脾气美图/KP写真/美女云图网/tck天天番号/4tck番号库/5pwc番号库/5tck天天番号/6K美女/7tck番号网/1凸5宅男福利/有脾气美图/极品番号社/过热E宅男天堂/杰瑞宅男频道/宅男番号库/PXA番号库/54k5宅男必备/0niz宅男频道/7k1a番号库/男人沉默宅男在线/7c0a宅男福利网站",
        host: ["www.6evu.com", "www.6kpo.com", "www.1plq.com", "www.c0h.net", "www.3tck.com", "www.3pxa.com", "www.4tck.com", "www.5pwc.com", "www.5tck.com", "www.6tck.com", "www.7tck.com", "www.7c0a.com", "www.1tu5.com", "www.wsqap.com", "www.gr2e.com", "www.joerei.com", "www.game1313.net", "www.54k5.com", "www.0niz.com", "www.7k1a.com", "www.1nlm.com"],
        reg: /^https?:\/\/www\.(6evu|6kpo|c0h|\dtck|3pxa|5pwc|7c0a|1tu5|wsqap|gr2e|joerei|game1313|54k5|0niz|7k1a|1nlm|1plq)\.(com|net)\/\d+\.html/,
        ...
        customTitle: () => fun.geT("h1").replace(/\(\d+P\)/i, "").replace(/超高清绝版网图流出|无圣光私房写真个人分享|无水印私房写真流出|无删减写真作品良心推荐|无删减写真大图流出|无圣光壁纸图片良心推荐|无圣光绝版网图传疯了|无水印私房照片收藏合集|高品质壁纸图片传疯了|高品质壁纸图片珍藏版|无圣光壁纸图片免费在线|无圣光私房写真良心推荐|超高清私家拍摄作品珍藏版|超高清私房照片在线浏览|无圣光写真作品流出|无水印壁纸图片良心推荐|无水印绝版网图在线浏览|无水印私房照片珍藏版|无水印私房照片个人分享/g, "").trim(),
        ...
        next: ".post-previous a",
        prev: ".post-next a",
        customTitle: () => fun.geT(".article_container>h1").replace(/\(\d+P\)|\d+P$/i, "").trim(),
        css: ".article_container{padding:10px 0px!important}#post_content{padding:0px!important}@media only screen and (max-width:640px){.container{max-width:100% !important}}",
        category: "nsfw1"
    }, {
        ...
        customTitle: () => fun.geT("h1").replace(/\s?\[\d+[\.\+\s\w-]+\]|\(\d+[\.\+\s\w-]+\)|\/?(\d+P)?|\|/gi, "").replace(/第\d+页|^- /g, "").trim(),
        topButton: true,
        fancybox: {
            v: 3,
            insertLibrarys: 1
        ...
        imgs: () => {
            ...
            return fun.getImgO("#picg img", max, 9, [null, null], 200, ".page .pagelist", siteUrl, 0);
        },
        button: [4],
        insertImg: ["#picg", 2],
        autoDownload: [0],
        ...
        reg: () => /portrait\.knit\.bid\/\w+\/\d+$/.test(siteUrl) && fun.ge(".container>.container>img") ? true : false,
        imgs: async () => {
        ...
        name: "美图网",
        host: ["meitu.knit.bid"],
        reg: () => /^https?:\/\/meitu\.knit\.bid\/(beauty|handsome)\/[^\/]+$/.test(siteUrl) && fun.ge(".details_item>img") ? true : false,
        imgs: async () => {
        ...
        reg: () => /^https?:\/\/(www\.)?446m\.com\/index\.php\/\w+\/\d+\.html/.test(siteUrl) && fun.ge(".post-content") ? true : false,
        imgs: "span.post-item",
        button: [4],
        insertImg: [".post-content", 2],
        ...
        customTitle: () => fun.geT("#entry-title").replace(/\[\d+[-\s\.\+\w]+\]/i, "").trim(),
        category: "nsfw1"
    }, {
        name: "好圖屋",
        host: ["www.haotuwu.com", "m.haotuwu.com"],
        reg: () => /(www|m)\.haotuwu\.com\/\w+\/\d+(\/page\/\d+)?(\.html)?$/.test(siteUrl) && fun.ge(".suoyou") ? true : false,
        init: () => {
        ...
        host: ["hotgirl.asia"],
        reg: () => /hotgirl\.asia\/.+\//.test(siteUrl) && fun.ge(".galeria_img") ? true : false,
        ...
        host: ["hotgirl.asia"],
        reg: () => /hotgirl\.asia\/.+\//.test(siteUrl) && fun.ge("#carouselImageIndicators") ? true : false,
        ...
        imgs: () => fun.getImg(".article__image-list img", fun.geT(".pagination__total") || 1),
        button: [4],
        ...
        imgs: async () => {
            ...
            let arr = await fun.getImg(".entry-content img", max);
            try {
                return arr.sort((a, b) => a.match(/(\d+)\.\w+$/)[1] - b.match(/(\d+)\.\w+$/)[1]);
            } catch (e) {
                return arr;
            }
        },
        ...
        reg: () => /^https?:\/\/nicegirl4u\.cyou\/[^\/]+\/$/.test(siteUrl) && fun.ge(".wp-block-image>img") ? true : false,
        ...
        imgs: async () => {
            let medias = parseInt(fun.geT("//p[contains(text(),'Media')]").match(/\d+/)[0], 10);
            if (medias > 24) {
        ...
        imgs: async () => {
            thumbnailsSrcArray = await fun.getImg("#content img", fun.geT("nav[aria-label=Pagination]>*:last-child", 2) || 1);
        ...
        imgs: async () => {
            ...
            for (let i = 1; i <= pages; i++) {
                let json = await fetch(`${location.origin}/${actorName}?page=${i}&type=photos&order=0`, {
                    "headers": {
                        "x-requested-with": "XMLHttpRequest"
                    }
                }).then(res => {
                ...
                let images = json.map(e => `${location.origin}/storage/` + e.image);
        ...
        reg: () => /\/content_\d+\.html$/.test(siteUrl) && fun.ge("//title[contains(text(),'自拍图库')]") ? true : false,
        init: () => fun.clearAllTimer(),
        imgs: ".showimg",
        button: [4],
        ...
        name: "美拍 - 我自拍",
        host: ["5zipai.com", "7aipai.com", "35zipai.com", "9zipai.net"],
        ...
        name: "套圖TAOTU.ORG",
        host: ["taotu.org"],
        reg: () => /^https?:\/\/(\w{2}\.)?taotu\.org\/[\w-]+\//.test(siteUrl) && fun.ge(".piclist") ? true : false,
        imgs: () => {
        ...
        imgs: () => [fun.ge(".content img").src.replace("/pic/", "/da/")],
        button: [4],
        ...
        imgs: () => fun.getImg("img.block", fun.geT("//a[text()='Next']", 2) || 1),
        button: [4],
        ...
        reg: () => /\/albums\//.test(siteUrl) && fun.ge("//title[contains(text(),'尤物丧志')]") ? true : false,
        imgs: () => fun.getImg("img.block", fun.geT("a[rel=next]", 2) || 1),
        button: [4],
        insertImg: ["//div[img[@title]]", 2],
        customTitle: () => fun.geT("#main>h1").replace(/未分类性感写真|^.+人体|AI图区/, "").trim(),
        category: "nsfw2"
    }, {
        name: "HotAsianX",
        host: ["hotasianx.com"],
        reg: /^https?:\/\/hotasianx\.com\/albums\//,
        imgs: async () => fun.checkImageCDN(await fun.getImg("img.block", fun.geT("a[rel=next]", 2) || 1)),
        button: [4],
        insertImg: ["//div[img[@title]]", 2],
        customTitle: () => fun.geT("#main>h1").replace(/未分类性感写真|^.+人体|AI图区/, "").trim(),
        category: "nsfw2"
        ...
        customTitle: () => fun.geT("h1.text-xl").replace(/（\d+月\d+打赏群(自购)?资源）|\[?\d+[\w\s\.\+-]+\]\s?|\[\d+P(\d+v)?-[\d\.]+(M|G)B\]|\[\d+P\]|\d+mb|\s?\d+p(\s?\+?\s?\d+V)?/gi, "").trim(),
        category: "nsfw2"
    }, {
        name: "美图",
        ...
        customTitle: () => fun.geT("h1.text-xl"),
        category: "nsfw1"
    }, {
        name: "福利姬美图",
        host: ["fuligirl.top"],
        ...
        customTitle: () => fun.geT("#main h1").replace(/（\d+月\d+打赏群(自购)?资源）|\[?\d+[\w\s\.\+-]+\]\s?|\[\d+P(\d+v)?-[\d\.]+(M|G)B\]|\[\d+P\]|\d+mb|\s?\d+p(\s?\+?\s?\d+V)?/gi, "").trim(),
        category: "nsfw2"
    }, {
        name: "顶尖美女图",
        host: ["djjpg.com"],
        ...
        delay: 1000,
        imgs: () => {
            let img = document.querySelector("img[variant='thumbnail']");
            let src = img.src;
            let srcKey = src.split("/").at(-1);
            let code = [...document.scripts].find(s => s.innerHTML.search(new RegExp(srcKey)) > -1).innerHTML;
            let imgKeys;
            if (/coverColumn/.test(code)) {
                imgKeys = code.match(/\\"images\\":\\"(\[[^\]]+\])/)[1].replaceAll("\\", "");
            } else {
                imgKeys = [...document.scripts].find(s => s.innerHTML.search(new RegExp(srcKey)) > -1).innerHTML.slice(23, -3).replaceAll("\\", "");
            }
            let imgKeysArr = JSON.parse(imgKeys);
            return imgKeysArr.map(key => "https://image.sharecosplay.com/" + key);
        },
        button: [4],
        insertImg: [".MuiBox-root.css-0", 2],
        customTitle: () => fun.geT(".MuiTypography-h4").replace(/\[\d+[\w\s\.\+-]+\]\s?/, "").trim(),
        category: "nsfw1"
    }, {
        ...
        delay: 1000,
        include: "a[aria-label='Go to next page']:not(.Mui-disabled)",
        autoPager: {
            mode: 1,
            waitEle: "img[variant='avatarThumbnail'],img[variant='avatar'],.MuiAvatar-img",
            ele: ".css-1tz8m30",
            observer: ".css-1tz8m30",
            next: "a[aria-label='Go to next page']:not(.Mui-disabled)",
            re: "nav[aria-label='pagination navigation']",
            title: doc => "Page " + fun.geT("a.Mui-selected", 1, doc),
            history: 1,
            bF: doc => {
                doc.querySelectorAll("img[variant='avatarThumbnail'],img[variant='avatar']").forEach(img => img.style.cssText = "color: transparent;");
                doc.querySelectorAll("img[variant='cover']").forEach(img => img.style.cssText = "position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent; object-fit: cover;");
            }
        },
        ...
        reg: () => /^https?:\/\/nudecosplay\.biz\/[^\/]+\/$|^https?:\/\/nudebird\.biz\/[^\/]+\/$/.test(siteUrl) && fun.ge("//p[a[img]]") ? true : false,
        init: () => {
        ...
        exclude: "//span[text()='Nude Cosplay Videos']",
        ...
        reg: () => /cosplaytele\.com\/[^/]+\//.test(siteUrl) && fun.ge("figure.gallery-item") ? true : false,
        ...
        name: "AsiaOnTop",
        host: ["asiaon.top"],
        reg: () => /^https?:\/\/asiaon\.top\/[^\/]+\/$/.test(siteUrl) && fun.ge(".modula-items") ? true : false,
        ...
        next: ".previous>a",
        prev: ".next>a",
        customTitle: () => fun.geT("h1.entry-title").replace(/.mitaku\.net./, "").trim(),
        category: "nsfw2"
    }, {
        name: "Cosplay World",
        host: ["cosplayworld.net"],
        reg: () => /^https?:\/\/cosplayworld\.net\/[^\/]+\/$/.test(siteUrl) && fun.ge(".entry-content") ? true : false,
        imgs: () => {
        ...
        customTitle: () => fun.geT(".entry-inner .entry-title").replace(/.mitaku\.net./, "").trim(),
        category: "nsfw2"
    }, {
        name: "Byoru",
        host: ["byoru.net"],
        ...
        reg: () => /nudeslegion.com\/[^\/]+\/$/.test(siteUrl) && fun.ge(".msacwl-slider-wrap") ? true : false,
        imgs: () => [...fun.gae(".msacwl-img")].slice(1, -1),
        button: [4],
        insertImg: [
        ...
        next: "a[rel=prev]",
        prev: "a[rel=next]",
        customTitle: () => fun.geT("h1.elementor-heading-title"),
        category: "nsfw1"
    }, {
        name: "Buon Dua",
        host: ["buondua.com", "buondua.us"],
        reg: /buondua\.(com|us)\/(?!hot|tag|collection)[^\?]+$/,
        imgs: () => fun.getImg(".article-fulltext img[alt]", fun.geT(".pagination-list>span:last-child>a").match(/\d+/)[0]),
        button: [4],
        ...
        customTitle: () => fun.geT(".title>h1").replace(/\(\d+[-\.\+\s\w]+\)/, "").trim(),
        css: "#rtb,.float-ck-center-lt,#popupContact,#backgroundPopupp,.col-9>.col-12,.col-3,#popup_se{display:none!important}.col-9{flex:unset!important;max-width:100%!important}",
        category: "nsfw2"
    }, {
        name: "Kenh69 自動翻頁",
        host: ["kenh69.co"],
        enable: 1,
        reg: /^https?:\/\/kenh69\.co\/(page\/\d+)?$|^https?:\/\/kenh69\.co\/category\//,
        init: () => {
        ...
        css: ".autoPagerTitle{width:100%!important}#backgroundPopupp,#popupContact,.float-ck-center-lt,center[style*='z-index'],#popup_se{display:none!important}",
        category: "autoPager"
    }, {
        name: "Kenh69去廣告",
        host: ["kenh69.co"],
        reg: /^https?:\/\/kenh69\.co\//,
        init: "$(document).off();",
        css: "#backgroundPopupp,#popupContact,.float-ck-center-lt,center[style*='z-index'],#popup_se{display:none!important}",
        category: "ad"
    }, {
        name: "Phym18/Bongda21h",
        host: ["phym18.pro", "bongda21h.vip"],
        link: "https://phym18.pro/tag/%E1%BA%A3nh-sex，https://bongda21h.vip/anh-hot/",
        reg: /phym18\.\w+\/anh\/[^/]+$|^https?:\/\/bongda21h\.\w+\/anh-hot\/[^\/]+\/$/,
        init: "$(document).off();",
        imgs: () => {
            try {
        ...
        css: "#wap_bottombannerr,#wap_bottombanner,#backgroundPopupp,#popupContact,center[style*='z-index'],#popup_se{display:none!important}",
        category: "nsfw2"
    }, {
        name: "Phym18 圖片分類自動翻頁",
        host: ["phym18.pro"],
        link: "https://phym18.pro/tag/%E1%BA%A3nh-sex",
        enable: 1,
        reg: /^https?:\/\/phym18\.\w+\/tag\/[^n]+nh-sex/,
        init: () => {
            fun.run("$(document).off();");
        ...
        autoPager: {
            ...
            lazySrc: "a[data-src]",
            title: () => "Page " + nextLink.match(/\d+$/)[0],
            aF: () => fun.remove("//div[div[a[div[text()='Free']]]]"),
            history: 1
        },
        openInNewTab: "div.item a:not([target=_blank])",
        css: "#bn_top,#backgroundPopupp,#popupContact,#wap_bottombannerr,#wap_bottombanner,center[style*='z-index'],#popup_se{display:none!important}.autoPagerTitle{margin-bottom: 30px!important}",
        category: "autoPager"
    }, {
        name: "Phym18/bongda21h去廣告",
        host: ["phym18.pro", "bongda21h.vip"],
        reg: /phym18\.\w+|bongda21h\.\w+/,
        init: "$(document).off();",
        css: "#bn_top,#backgroundPopupp,#popupContact,#wap_bottombannerr,#wap_bottombanner,center[style*='z-index'],#popup_se{display:none!important}",
        category: "ad"
    }, {
        name: "Porn Pics",
        ...
        next: "a[rel=prev]",
        prev: "a[rel=next]",
        customTitle: () => fun.geT("article h1").replace(/（\d+Photos）\s|\（\d+Photos\)\s|\d+Photos\s|\d+\spics|\(选登\)|（选登\d+P）/, ""),
        category: "nsfw1"
    }, {
        name: "J M G T的AList",
        ...
        reg: () => /((www\.)?meijuntu\.com|(www\.)?junmeitu\.com|(www\.)?jeya\.\w+)\/\w+\/\w+\.html/i.test(siteUrl) && fun.ge(".pictures img") ? true : false,
        imgs: async () => {
            let imgsArr = [];
        ...
        reg: () => /^https?:\/\/www\.wai\d{2}\.com\/[^\/]+\//.test(siteUrl) && fun.ge(".entry-content div[data-src]") ? true : false,
        imgs: async () => {
        ...
        button: [4],
        insertImg: [".message", 2],
        customTitle: () => fun.geT(".media-body>span.break-all").replace(/\(\d+p\)/i, "").trim(),
        category: "nsfw1"
    }, {
        name: "美女库",
        ...
        name: "2LSP",
        host: ["2lsp.xyz"],
        reg: () => /2lsp\.xyz\/[^/]+\/$/.test(siteUrl) && fun.ge(".entry-content img[data-srcset]") && !fun.ge(".content-hide-tips") ? true : false,
        ...
        reg: () => /(myjkwd\.com|enpeta\.com|534798\.xyz|539765\.xyz|123548\.xyz)\/e\/action\/ShowInfo\.php/i.test(siteUrl) && fun.ge(".entry img") ? true : false,
        ...
        customTitle: () => fun.geT(".contitle").replace(/\[\d+P\]/, ""),
        css: "aside.side{display:none!important;}.main-content{margin-left:0px!important;}body{background:#EDEDED!important;}",
        category: "nsfw2"
    }, {
        name: "多伦多情色",
        host: ["torontolove.cc"],
        reg: () => /^https?:\/\/torontolove\.cc\/detail\?id=\d+/i.test(siteUrl) && fun.ge("//div[@class='post-topic']//div[text()='情色靓影']") ? true : false,
        imgs: () => [...fun.gae("#J-description-conent img")].map(e => e.currentSrc),
        button: [4],
        insertImg: ["#J-description-conent", 2],
        customTitle: () => fun.geT("#J-main-title"),
        fancybox: {
            v: 3,
            css: false
        },
        ...
        name: "苍井优图",
        host: ["www.28tyu.com", "www.28rty.com", "www.28wer.com", "sldlxz.com", "282471.xyz", "284019.xyz"],
        reg: /((www\.|a\.)(\d+tyu|\d+rty|\d+wer)\.com|sldlxz\.com|282471|284019\.xyz)\/e\/action\/ShowInfo\.php/i,
        ...
        reg: () => /^https?:\/\/www\.modelsvibe\.com\/[^/]+\/$/.test(siteUrl) && fun.ge(".td-post-content img") ? true : false,
        init: () => {
        ...
        reg: /(goddess247|bestprettygirl)\.com\/(?!tag).+\//,
        ...
        button: [4],
        insertImg: [".post-content", 2],
        customTitle: () => fun.geT("h1.post-title").replace(/\s?\(\d+[\s\w]+\)|\s?\(\d+\s?photos(\s?\+\s?\d+\s?videos?)?\)/i, ""),
        category: "nsfw1"
    }, {
        name: "움짤저장소 KPOP GIRLGROUPS ACTOR",
        host: ["kkoreaactor.blogspot.com"],
        reg: /kkoreaactor\.blogspot\.com\/\d+\/\d+\/[\w-]+\.html/,
        imgs: ".separator>a",
        imgs: () => {
            videosSrcArray = [...fun.gae("video>source[type='video/mp4']")].map(e => e.src);
            thumbnailsSrcArray = [...fun.gae(".separator>a img")].map(e => e.src.replace("/s600/", "/w100/"));
            return [...fun.gae(".separator>a")];
        },
        button: [4],
        insertImg: [".entry-content", 2],
        customTitle: () => fun.geT("h1.post-title").replace(/\s?\(\d+[\s\w]+\)|\s?\(\d+\s?photos(\s?\+\s?\d+\s?videos?)?\)/i, ""),
        ...
        reg: () => /^https?:\/\/((www\.)?(madoucun|mamamcn|tangxvlog|guodongmcn|proncn)\.com|(www\.)?mrrabbit\.org|(www\.)?xvideo\.bar|(www\.)?md101\.tv)\/artdetail-\d+/.test(siteUrl) && fun.ge(".hl-article-box img,.news-content img") ? true : false,
        imgs: ".hl-article-box img,.news-content img",
        button: [4],
        insertImg: [".hl-article-box,.news-content", 2],
        customTitle: () => fun.geT(".hl-article-title,.news-title"),
        category: "nsfw2"
    }, {
        name: "淫淫小说写真馆",
        ...
        go: 1,
        customTitle: () => fun.geT(".galleryhead>h3>a"),
        category: "nsfw2"
    }, {
        name: "wikiFeet",
        ...
        init: () => fun.remove("//iframe|//div[div[center[script[contains(text(),'juicy')]]]][@class='container']"),
        imgs: async () => {
            let max;
            try {
        ...
        host: ["www.xasiat.com"],
        link: "https://www.xasiat.com/albums/",
        reg: () => /www\.xasiat\.com\/albums\//.test(siteUrl) && fun.ge("#list_albums_common_albums_list_pagination") ? true : false,
        init: () => {
            setInterval(() => {
        ...
        button: [4],
        insertImg: [".entry-content", 2],
        customTitle: () => fun.geT(".entry-title").replace(/\s–\s\d+\spics/, ""),
        category: "nsfw2"
    }, {
        ...
        reg: () => /xhamster\.com\/photos\/gallery\/[^/]+$/.test(siteUrl) && fun.ge(".gallery-section") ? true : false,
        imgs: async () => {
            await fun.getNP(".photo-thumb, #initials-script", "//div[@class='gallery-section']//li[a[contains(@class,'active')]]/following-sibling::li[1]/a", null, ".gallery-section .pager-section");
        ...
        name: "Fuskator 大圖頁",
        host: ["fuskator.com"],
        reg: () => /^https?:\/\/fuskator\.com\//i.test(siteUrl) && fun.ge("//a[text()='View gallery thumbnails']") ? true : false,
        imgs: "img.full",
        button: [4],
        ...
        button: [4],
        insertImg: ["#content", 2],
        customTitle: () => fun.geT("h1.title").replace(/\d+P|\s?\(\d+[\s\w]+\)/i, ""),
        fancybox: {
            v: 3,
            css: false
        },
        ...
        imgs: () => {
            let max = fun.geT(".count-pageindex") || 1;
        ...
        reg: () => /^https?:\/\/www\.hentaicos\.com\/\w+\/\d+\.html/.test(siteUrl) && fun.ge(".main-picture") ? true : false,
        imgs: () => fun.getImg(".main-picture img", fun.geT("//a[text()='Next']", 2) || 1, 9),
        button: [4],
        ...
        imgs: async () => {
            ...
            if (URLs.length > 0) {
                fun.showMsg(displayLanguage.str_01, 0);
                let xhrNum = 0;
                let resArr = URLs.map(async (a, i, arr) => {
                    await fun.delay(100 * i, 0);
                    let url = a.href;
                    if (/imx\.to/.test(url)) {
                ...
                await Promise.all(resArr).then(arr => {
                    let thumbnails = URLs.map(a => fun.ge("img", a).src);
                    thumbnailsSrcArray = thumbnailsSrcArray.concat(thumbnails);
        ...
        name: "亚洲色吧",
        host: ["yazhouseba.com"],
        reg: () => /^https?:\/\/yazhouseba\.com\/meinv\/img-\d+\.html/.test(siteUrl) && fun.ge("#next-url") ? true : false,
        imgs: async () => {
        ...
        reg: () => /^https?:\/\/(www\.wind5\.com|www\.mayihz\.com)\/tu\d+\.html$/.test(siteUrl) && fun.ge("#portfolio img") ? true : false,
        imgs: () => {
            let max;
            try {
        ...
        next: "a[title='上一篇']",
        prev: "a[title='下一篇']",
        customTitle: () => fun.geT("h1.fed-swip-head"),
        category: "nsfw1"
    }, {
        name: "亿秀美女",
        host: ["www.tu11.com", "m.itu11.com"],
        reg: () => /^https?:\/\/(www|m)\.i?tu11\.com\/\w+\/\d+\/\d+\.html/.test(siteUrl) && fun.ge("#showimg img,.img-box img") ? true : false,
        imgs: async () => {
            await fun.getNP("#showimg img,.img-box img", "a.curpage+a:not(.prepage)", null, "#paginationEle", 0, null, 0);
        ...
        customTitle: () => fun.ge(".title>div[style],.imgWrap a,.name>a") ? fun.geT(".title>div[style],.imgWrap a,.name>a").replace(/\(\d+p\)|\s?\(.+\)\s?/i, "").trim() : fun.ge(".main_column_pic img").alt.replace(/\(\d+p\)|\s?\(.+\)\s?/i, "").trim(),
        category: "nsfw2"
    }, {
        name: "中国人体艺术模特网",
        ...
        reg: () => /^https?:\/\/(www\.)?xingaiba\.com\/\?action-viewnews-itemid-\d+$/.test(siteUrl) && fun.ge("//span[contains(text(),'美图类别')]") ? true : false,
        imgs: async () => {
        ...
        next: ".next>a",
        prev: ".pre>a",
        customTitle: () => fun.geT(".articleTitle>h1"),
        category: "nsfw1"
    }, {
        name: "空图美女网",
        ...
        next: ".prev>a",
        prev: ".next>a",
        customTitle: () => fun.geT("h1.tit").replace(/\d+p/i, ""),
        ...
        next: "a[title^='下一篇']",
        prev: "a[title^='上一篇']",
        customTitle: () => fun.geT(".article-title>h1"),
        category: "nsfw2"
    }, {
        name: "上流时尚人体艺术",
        ...
        reg: /^https?:\/\/\w{2}\.(kawaii(\w+)?|kinkygirlz|assxpic|metaxpic|metaxgirl|eroticxgirl|sexyxpic|hottyxpic|thongxxx|juicexgirl|eroticxpic|bustyxgirl|beautyxgirl|bellexpic|pantyxpic|peachgirlz|pantyxart|beautyxpic|cutemetas|cutexpic|perfectxbody|sexyqgirl|bestxhips|bestxass|assgirlz|bestxbum|adultmetas|eroticxpic|xxxthong|thongxgirl|bestxlingerie|sexyxart|hotxhips|hotbeautypic|greatxgirl|asianxpic|bootyxgirl|tokyohotgirl)\.com\/[^/]+\/\w+/,
        include: "//a[@data-title and picture/source]",
        ...
        imgs: () => fun.getImg(".tal a>img[alt]", fun.geT(".article_page a").match(/\/(\d+)/)[1], 11),
        button: [4],
        insertImg: [".tal", 2],
        ...
        imgs: () => fun.getImg(".main>div>a>img[alt],.warp .content>a>img[alt]", fun.geT("//span[@class='current']/preceding-sibling::a|//a[@class='thisclass']/preceding-sibling::a").match(/\d+/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg(".main>div>a>img[alt]", fun.geT(".main span", 2).match(/\d+/)[0], 11),
        button: [4],
        ...
        enable: 0,
        init: "document.onkeydown=null;",
        imgs: () => fun.getImg(".imgbox>a>img[alt]", fun.geT(".page>span#hover", 3).match(/\d+$/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg(".imgbox>a>img[alt]", fun.geT(".pagelist>a").match(/\d+/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg(".tu>a>img[alt]", fun.geT(".page-show>span.current", 2).match(/\d+/)[0], 9),
        button: [4],
        ...
        imgs: () => fun.getImg(".tu>a>img[alt]", fun.geT(".page-show>span.current", 2).match(/\d+/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg(".content-pic img[alt]", fun.geT(".current", 2).match(/\d+/)[0], 9),
        button: [4],
        ...
        imgs: () => fun.getImg(".content img[alt]", fun.geT("#hover", 2).match(/\d+/)[0], 9),
        button: [4],
        insertImg: [".content", 2],
        autoDownload: [0],
        ...
        host: ["03hb.com"],
        reg: /03hb\.com\/\w+\/\d+\//i,
        imgs: () => fun.getImg(".content img[alt]", fun.geT("#hover", 2).match(/\d+/)[0], 11),
        button: [4],
        insertImg: [".content", 2],
        autoDownload: [0],
        next: "//span[contains(text(),'下一')]/a",
        ...
        init: "document.onkeydown=null;",
        imgs: () => fun.getImg('#content img[alt]', fun.geT('.pagelist>strong', 2).match(/\d+/)[0], 9),
        button: [4],
        insertImg: ["#content", 2],
        autoDownload: [0],
        next: "//span[contains(text(),'下一')]/a",
        ...
        imgs: () => fun.getImg("#content img[alt]", fun.geT(".pagelist>a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: ["#content", 2],
        autoDownload: [0],
        next: "//span[contains(text(),'下一')]/a",
        ...
        imgs: () => fun.getImg(".imgbox img[alt]", fun.geT(".pagelist>.curent", 2).match(/\d+/)[0], 9),
        button: [4],
        insertImg: [".imgbox", 2],
        autoDownload: [0],
        next: "//li[contains(text(),'下一')]/a",
        ...
        init: "document.onkeydown=null;",
        imgs: () => fun.getImg(".pp.hh img[alt]", fun.geT(".page-show>.current", 2).match(/\d+/)[0], 9),
        button: [4],
        insertImg: [".pp.hh", 2],
        ...
        init: "document.onkeydown=null;",
        imgs: () => fun.getImg(".pp.hh img[alt]", fun.geT(".page-show>.current", 2).match(/\d+/)[0], 11),
        button: [4],
        insertImg: [".pp.hh", 2],
        customTitle: () => fun.geT(".des>h1").split(",")[0],
        category: "nsfw2"
        ...
        imgs: () => fun.getImg(".content img[alt]", fun.geT(".page-show>a,.page>a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: [".content", 2],
        autoDownload: [0],
        next: "//span[contains(text(),'下一')]/a",
        ...
        imgs: () => fun.getImg(".content-pic img[alt],#bomei img[alt]", fun.geT(".page-show>a").match(/\d+/)[0], 11),
        button: [4],
        ...
        host: ["188rt.com"],
        reg: /188rt\.com\/\w+\/\d+\//i,
        imgs: () => fun.getImg("#bomei img[alt]", fun.geT(".page-show>a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: ["#bomei", 2],
        autoDownload: [0],
        next: "#prenext a",
        ...
        imgs: () => fun.getImg("#content-p img[alt]", fun.geT(".thispg", 2).match(/\d+/)[0], 9),
        button: [4],
        ...
        imgs: () => fun.getImg(".content img[alt]", fun.geT(".thisclass", 2).match(/\d+/)[0], 9),
        button: [4],
        insertImg: [".content", 2],
        autoDownload: [0],
        ...
        imgs: () => fun.getImg(".content img[alt]", fun.geT(".thisclass", 2).match(/\d+/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg(".picbox img[alt]", fun.geT(".thisclass", 2).match(/\d+/)[0], 11),
        button: [4],
        insertImg: [".picbox", 2],
        autoDownload: [0],
        ...
        host: ["44aq.com"],
        reg: /44aq\.com\/\w+\/\d+\//i,
        imgs: () => fun.getImg(".picbox img[alt]", fun.geT(".page a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: [".picbox", 2],
        autoDownload: [0],
        next: ".updown_r>a",
        ...
        imgs: () => fun.getImg(".img_content img[alt]", fun.geT("#hover", 2).match(/\d+/)[0], 9),
        button: [4],
        ...
        imgs: () => fun.getImg(".content_pic img[alt]", fun.geT(".current", 2).match(/\d+/)[0], 11),
        button: [4],
        ...
        host: ["488xm.com"],
        reg: /488xm\.com\/\w+\/\d+\//i,
        imgs: () => fun.getImg("#content img[alt]", fun.geT(".pagelist>strong", 2).match(/\d+/)[0], 11),
        button: [4],
        insertImg: ["#content", 2],
        autoDownload: [0],
        next: "//span[contains(text(),'下一')]/a",
        ...
        imgs: () => fun.getImg("#gallery img[alt]", fun.geT(".pagination>a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: ["#gallery", 2],
        autoDownload: [0],
        next: ".other-prev a",
        ...
        imgs: () => fun.getImg("#content img[alt]", fun.geT(".content-page>a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: ["#content", 2],
        ...
        imgs: () => fun.getImg("#showimages img[alt]", fun.geT(".bigpages>a").match(/\d+/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg(".section.fix.tc img[alt]", fun.geT(".pages a").match(/\d+/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg("#content-p img[alt]", fun.geT(".page a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: ["#content-p", 2],
        customTitle: () => fun.title(",", 1),
        category: "nsfw2"
        ...
        imgs: () => fun.getImg(".image-view img[alt]", fun.geT(".pages a").match(/\d+/)[0], 11),
        button: [4],
        ...
        imgs: () => fun.getImg("#content-p img[alt]", fun.geT(".gengduo a").match(/\d+/)[0], 11),
        button: [4],
        ...
        host: ["22bb.org"],
        reg: /22bb\.org\/\w+\/\d+\//i,
        imgs: () => fun.getImg(".content img[alt]", fun.geT(".page-show>a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: [".content", 2],
        autoDownload: [0],
        next: "//span[contains(text(),'下一')]/a",
        ...
        host: ["444wp.com"],
        reg: /444wp\.com\/\w+\/\d+\//i,
        imgs: () => fun.getImg(".content img[alt]", fun.geT(".page a").match(/\d+/)[0], 11),
        button: [4],
        insertImg: [".content", 2],
        autoDownload: [0],
        next: ".page+.page a",
        ...
        host: ["28xv.com"],
        reg: /28xv\.com\/\w+\/\d+\//i,
        imgs: () => fun.getImg(".imgTip+a>img[alt]", fun.geT(".page a").match(/\d+/)[0], 11),
        button: [4],
        ...
        reg: () => /^https?:\/\/dbro\.news\/\d+\/[^\.]+\.html$/i.test(siteUrl) && fun.ge("p.pic_center,.content_left img") ? true : false,
        ...
        reg: () => /^https?:\/\/jo106\.com\/\d+\/$/i.test(siteUrl) && fun.ge("//div[@class='cat-links']/a[text()='美女圖片'][@rel='category tag']") ? true : false,
        ...
        reg: () => /\/art\/pic\/id\/\d+\/$/i.test(siteUrl) && fun.ge("//title[contains(text(),'XO福利圖')]") ? true : false,
        ...
        name: "XO福利圖 分類自動翻頁",
        enable: 1,
        reg: () => /^https?:\/\/[^\/]+\/arttype\//.test(siteUrl) && fun.ge("//title[contains(text(),'XO福利圖')]") ? true : false,
        autoPager: {
        ...
        reg: () => /^https?:\/\/18jjj\.\w+\/chapter\/\d+$/i.test(siteUrl) && fun.ge("#enc_img img") ? true : false,
        init: () => {
            fun.clearAllTimer();
        ...
        customTitle: () => fun.geT(".entry-header").replaceAll("|", "-"),
        css: "#FullPictureLoadEnd{color:rgb(255, 255, 255)}",
        category: "nsfw1"
    }, {
        name: "Kungfutv",
        ...
        customTitle: () => fun.geT(".panel-heading>.pull-left"),
        fetch: 1,
        css: "#FullPictureLoadEnd{color:rgb(255, 255, 255)}",
        category: "hcomic"
    }, {
        ...
        customTitle: async () => {
            let text = await fun.fetchDoc(fun.ge("//a[span[text()='漫畫簡介']]").href).then(albumDoc => {
                let comicName = fun.geT(".panel-heading h1", 1, albumDoc);
                let episode = fun.ge(".episode", albumDoc);
                return episode ? comicName + " - " + fun.geT(".panel-heading>.pull-left") : comicName;
            });
            return text.replace(/\(\d+[\w\s\.\+-]+\)/i, "").trim();
        },
        category: "hcomic"
    }, {
        name: "禁漫天堂",
        host: ["18comic.vip", "18comic.org", "18comic-cn.vip", "18comic-palworld.club", "18comic-c.xyz", "18comic-c.art", "18comic-fun.xyz", "jmcomic.me", "jmcomic1.me", "jm-comic1.art", "jm-comic2.art", "jm-comic3.art"],
        reg: /^https?:\/\/(18comic.(vip|org)|18comic-cn\.vip|18comic-palworld\.club|18comic-c\.xyz|18comic-c\.art|18comic-fun\.xyz|jmcomic\d?\.me|jm-comic\d.art)\/photo\/\d+/,
        init: async () => {
            setTimeout(() => {
                fun.ge("#chk_cover").click();
        ...
        imgs: async () => {
            ...
            let arr = [];
            let fetchNum = 0;
            let imgs = [...document.querySelectorAll(".scramble-page img,.owl-item .center img")];
        ...
        customTitle: () => {
            return fun.fetchDoc(fun.ge("//a[span[text()='漫畫簡介']]").href).then(albumDoc => {
                let comicName = fun.geT(".panel-heading h1", 1, albumDoc).replaceAll("/", "").replace(/\s?\[禁漫漢化組\]/, "");
                let episode = fun.ge(".episode", albumDoc);
                if (episode) {
                    let id = location.pathname.match(/\d+/)[0];
                    let selector = `.episode a[data-album="${id}"]`;
                    let text = fun.geT(selector, 1, albumDoc);
        ...
        init: async () => await fun.getNP(".gdtm,.gdtl", ".ptds+td>a", null, "//tr[td[@class='ptds']]"),
        imgs: async () => {
        ...
        init: async () => await fun.getNP(".gi", "//a[text()='Next Page >']", null, "#ia"),
        ...
        name: "nhentai圖片清單頁",
        host: ["nhentai.net", "nyahentai.red", "www.hentai.name", "nhentai.xxx", "nhentai.to", "simplyhentai.org", "simplyhentai.red"],
        reg: /(nhentai\.net|nyahentai\.red|www\.hentai\.name|nhentai\.xxx|nhentai\.to|simplyhentai\.org|simplyhentai\.red)\/g\/\d+\/?$/,
        imgs: async () => {
            ...
            if (/nhentai\.net/.test(siteUrl)) {
                ...
                return iframe.reader.gallery.images.pages.map((e, i) => imgDir + (i + 1) + "." + {
                    j: "jpg",
                    p: "png",
                    g: "gif"
                } [e.t]);
            } else if (/simplyhentai\.org|simplyhentai\.red/.test(siteUrl)) {
                ...
                return [...fun.gae(".thumb-container img")].map(e => e.src.replace("_thumb.jpg", ".jpg").replace("_thumb.png", ".png").replace("_thumb.webp", ".webp"));
            }
        },
        button: [4],
        insertImg: [
        ...
        name: "Anchira 分類自動翻頁",
        enable: 1,
        reg: async () => /^https?:\/\/anchira\.to\/(trending|\?)/.test(siteUrl) && await fun.waitEle(".pagination") && await fun.waitEle(".galleries") ? true : false,
        autoPager: {
            mode: 1,
        ...
        imgs: async () => {
            ...
            let json = await fun.fetchDoc(url).then(doc => {
                let code = [...doc.scripts].find(s => s.innerHTML.search(/readerPages/) > -1).innerHTML;
        ...
        customTitle: () => fun.geT("#main-info>h2").replace("|", "-"),
        go: 1,
        topButton: true,
        threading: 4,
        ...
        customTitle: () => fun.geT(".reader-title").replace("|", "-"),
        threading: 4,
        category: "hcomic"
    }, {
        name: "HentaiFox圖片清單頁",
        host: ["hentaifox.com"],
        reg: () => /hentaifox\.com\/gallery\/\d+\/$/.test(siteUrl) && fun.ge(".view_group") ? true : false,
        imgs: async () => {
            fun.showMsg(displayLanguage.str_04, 0);
        ...
        autoClick: ["#load_all"],
        customTitle: () => fun.geT(".info>h1").replace("|", "-"),
        go: 1,
        topButton: true,
        threading: 4,
        category: "hcomic"
        ...
        imgs: () => {
            ...
            return reader.gallery.images.pages.map((e, i) => imgDir + (i + 1) + "." + {
                j: "jpg",
                p: "png",
                g: "gif"
            } [e.t]);
        ...
        customTitle: () => fun.geT(".reader-title"),
        category: "hcomic"
    }, {
        name: "Pururin圖片清單頁",
        host: ["pururin.to"],
        ...
        imgs: () => {
            let imgDir = fun.ge("#fimg").dataset.src.match(/.+\//)[0];
            let max = fun.ge("#pages").value;
            let arr = fun.arr(max).map((_, i) => imgDir + (i + 1) + ".jpg");
            thumbnailsSrcArray = arr.map(e => e.replace(/(\.\w+)$/, "t$1"));
            return arr;
        ...
        name: "MultPorn閱讀頁",
        host: ["multporn.net"],
        reg: () => /multporn\.net\//.test(siteUrl) && fun.ge("//script[contains(text(),'configUrl')]") ? true : false,
        imgs: () => {
        ...
        name: "HentaiHere閱讀頁",
        host: ["hentaihere.com"],
        reg: () => /hentaihere\.com\/m\/\w+\/\d+\/\d+\/$/i.test(siteUrl) && fun.ge("//script[contains(text(),'rff_imageList')]") ? true : false,
        init: "$(document).off();",
        ...
        reg: () => /hdporncomics\.com\/[^/]+\/([^/]+\/)?$/i.test(siteUrl) && fun.ge(".my-gallery.scrollmenu") ? true : false,
        imgs: () => {
        ...
        name: "Doujins圖片清單頁",
        host: ["doujins.com"],
        reg: () => /doujins\.com\/.+\/.+/i.test(siteUrl) && fun.ge("#thumbnails") ? true : false,
        ...
        imgs: async () => {
            ...
            return fun.fetchDoc(url).then(doc => {
                ...
                let code = [...doc.scripts].find(s => s.innerHTML.search(/extensions/) > -1).innerHTML;
                let extensions = fun.run(code.match(/\[.+\]/)[0].replaceAll("&quot;", '"'));
                return extensions.map((e, i) => imgDir + (i + 1) + "." + {
                    j: "jpg",
                    p: "png",
                    g: "gif"
                } [e]);
        ...
        imgs: async () => {
            ...
            fun.showMsg(displayLanguage.str_05, 0);
            return fun.fetchDoc(url).then(doc => {
                let code = [...doc.scripts].find(s => s.innerHTML.search(/slides/) > -1).innerHTML;
        ...
        customTitle: () => {
            let text = fun.geT("h1.detail-ttl");
        ...
        autoClick: ["#load_all"],
        imgs: () => {
            thumbnailsSrcArray = [...fun.gae("#append_thumbs img")].map(e => e.dataset.src ?? e.src);
        ...
        imgs: async () => {
            ...
            return fun.arr(thumbnailsSrcArray.length).map((_, i) => imgDir + (i + 1) + key);
        },
        button: [4],
        insertImg: [
        ...
        name: "HentaiHand圖片清單頁",
        host: ["hentaihand.com"],
        reg: /^https?:\/\/hentaihand\.com\/en\/comic\/[^\/]+$/,
        init: async () => {
            let comic = location.href.split("/").at(-1);
            let json = await fetch(`https://hentaihand.com/api/comics/${comic}/images`, {
                "headers": {
        ...
        go: 1,
        customTitle: () => fun.ge("#gn+h1") ? fun.geT("#gn+h1") : fun.geT("#gn,.entry-title"),
        fancybox: {
            v: 3,
            css: false
        },
        ...
        imgs: async () => {
            let chapterName = fun.geT(".chapter-name");
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => fun.getImg("#ComicPic", fun.ge("#total", doc).value, 20, [null, null], 20, url, msg, request),
        button: [4, "24%", 1],
        insertImg: [".e", 2],
        autoDownload: [0],
        next: "//a[text()='下一章']",
        ...
        imgs: ".elementor-widget-text-editor img[decoding]",
        button: [4],
        insertImg: [".elementor-widget-text-editor", 2],
        ...
        reg: () => /^https?:\/\/www\.acgnbus\.com\/\w+\/\d+\.html$/.test(siteUrl) && fun.ge(".main-picture") ? true : false,
        imgs: () => fun.getImg(".main-picture img", fun.geT("//a[text()='下一页'][@class='a1']", 2), 5),
        button: [4],
        insertImg: [".entry-content", 2],
        next: ".post-next a",
        prev: ".post-pre a",
        ...
        go: 1,
        customTitle: () => {
            if (/twhentai|mttang/.test(location.host)) {
                return fun.geT(".recommended-info h3");
            } else {
        ...
        name: "91漫屋/欲漫涩/腐漫屋",
        host: ["91manwu.com", "yumanse.com", "fumanwu.org"],
        reg: /^https?:\/\/(91manwu\.com|yumanse\.com|fumanwu\.org)\/vodplay\/[\d-]+\.html$/,
        ...
        imgs: () => {
            ...
            return fun.getImgO("#comic", max, "4", [null, null], 0, ".entry-title,.wp-pagenavi", siteUrl, 0);
        },
        button: [4],
        ...
        go: 1,
        customTitle: () => fun.geT(".g1-breadcrumbs-item>span[itemprop=name]"),
        ...
        init: () => fun.clearAllTimer(),
        imgs: () => fun.getImg(".context img", fun.geT(".pages").match(/\d+/g)[1], 7),
        button: [4],
        insertImg: [".context", 2],
        autoDownload: [0],
        next: ".post-previous a",
        prev: ".post-next a",
        customTitle: () => fun.geT("#content h1").replace(/\[\d+P\]|〈|〉/gi, ""),
        category: "hcomic"
    }, {
        name: "那露漫画",
        host: ["naluhd.com"],
        ...
        next: ".j-rd-next,.next-btn",
        prev: ".j-rd-prev,.prev-btn",
        customTitle: () => fun.ge(".rd-article-wr") ? fun.geT(".read__crumb").replace("首页  ", "").replace("  ", " - ") : shareArr[0].match(/《([^》]+)/)[1] + " - " + fun.geT(".comic-name"),
        category: "hcomic"
    }, {
        name: "日漫之家",
        ...
        prev: ".j-rd-prev,.prev-btn",
        customTitle: () => fun.ge(".rd-article-wr") ? fun.geT(".j-comic-title") + " - " + fun.geT(".comic-title>a").replace(/\d+p/i, "") : shareArr[0].match(/《([^》]+)/)[1] + " - " + fun.geT(".comic-name").replace(/\d+p/i, ""),
        ...
        next: () => {
            ...
            if (next) {
                ...
                let url = `https://${location.host}/#/pages/read/read?no=${no+=1}&id=${mhid}`;
                return url;
            }
            return null;
        },
        ...
        customTitle: () => fun.geT(".services-desc"),
        category: "hcomic"
    }, {
        name: "頂點漫畫",
        host: ["www.apexmh.com"],
        reg: /^https?:\/\/www\.apexmh\.com\/comic\/\d+\.html/,
        imgs: () => fun.getImg("#showimg img", fun.geT("//p[contains(text(),'图片数量') or contains(text(),'圖片數量')]").match(/\d+/)[0], 9),
        button: [4],
        insertImg: ["#showimg", 2],
        customTitle: () => fun.geT("h1"),
        category: "hcomic"
        ...
        delay: 1000,
        init: () => fun.remove(".imgBox"),
        imgs: () => atob(qTcms_S_m_murl_e).split("$qingtiandy$").map(e => e.replace("////", "//")),
        button: [4],
        ...
        go: 1,
        customTitle: () => fun.geT(".headline>h2").replace(/\(\d+P\)/, ""),
        category: "hcomic"
    }, {
        name: "色漫集",
        host: ["semanji.xyz"],
        ...
        go: 1,
        customTitle: () => fun.geT(".blog_section h1,.blog_section h3"),
        ...
        prev: ".j-rd-prev",
        customTitle: () => fun.geT(".j-comic-title") + " - " + fun.geT(".last-crumb"),
        category: "hcomic"
    }, {
        name: "400漫画网M",
        host: ["400manhua.com"],
        ...
        prev: "li.prev",
        customTitle: () => fun.geT("//p[@class='end-txt'][span[contains(text(),'阅读')]]").replace("您已阅读完：", "").replace("漫画", " - "),
        ...
        init: async () => {
            ...
            let code = fun.geT("//script[contains(text(),'$(document).ready')]");
        ...
        scrollEle: () => fun.aotoScrollEles(".mh_comicpic", (ele) => fun.ge("img[src]", ele)),
        next: "//a[text()='下一章']",
        prev: "//a[text()='上一章']",
        ...
        prev: "#prevvol",
        customTitle: doc => fun.geT(".text-view-title", 1, doc) + " - 第" + fun.geT("#lastchapter", 1, doc) + "集",
        preloadNext: () => {
...
document.body.appendChild(text);
            ...
            let arr = fun.geT("#FullPictureLoadReturn", 1, nextIframeDoc).split("|");
        ...
        imgs: (msg = 1) => {
            ...
            let resArr = fun.arr(MANGABZ_IMAGE_COUNT).map((_, i) => {
                let apiUrl = location.origin + MANGABZ_CURL + "chapterimage.ashx" + `?cid=${MANGABZ_CID}&page=${(i + 1)}&key=${mkey}&_cid=${MANGABZ_CID}&_mid=${MANGABZ_MID}&_dt=${MANGABZ_VIEWSIGN_DT}&_sign=${MANGABZ_VIEWSIGN}`;
        ...
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'MANGABZ_IMAGE_COUNT')]", 1, nextDoc);
            fun.script(code, 0, 1);
        ...
        customTitle: doc => fun.title('_', 2, doc).replace("漫畫", ""),
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'XMANHUA_IMAGE_COUNT')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(await obj.imgs(0), obj.customTitle(nextDoc), "next");
        },
        ...
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'DM5_IMAGE_COUNT')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(await obj.imgs(0), obj.customTitle(nextDoc), "next");
        },
        topButton: true,
        ...
        customTitle: doc => fun.title("_", 2, doc).replace("漫畫", ""),
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'YYMANHUA_IMAGE_COUNT')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(await obj.imgs(0), obj.customTitle(nextDoc), "next");
        },
        css: "#FullPictureLoadEnd{color:rgb(255, 255, 255)}.relative>a{display:none!important}.reader-img-con{padding:64px 0 50px !important;}",
        ...
        customTitle: doc => {
            ...
            if (/dm5|manhuaren|1kkk|mangabz|xmanhua|yymanhua/.test(host) && !/sixmanhua/.test(host)) {
                ...
                if (fun.ge("#comicTitle")) {
                    return fun.geT("#chapter", 1, doc) + " " + fun.geT(".title-comicHeading", 1, doc);
                } else {
        ...
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'newImgs')]", 1, nextDoc);
            fun.script(code, 0, 1);
        ...
        customTitle: doc => fun.title("_", 2, doc).replace("漫畫", ""),
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'MH234_IMAGE_COUNT')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(await obj.imgs(0), obj.customTitle(nextDoc), "next");
        },
        css: "#FullPictureLoadEnd{color:rgb(255, 255, 255)}a[href^='j']{display:none !important}body{overflow:unset!important}",
        ...
        init: () => {
            ...
            fun.addUrlHtml("https://dogemanga.com/", ".imgBox", 1, "首頁");
            siteData.next() ? fun.addUrlHtml(siteData.next(), ".imgBox", 1) : null;
        },
        imgs: doc => [...fun.gae(".site-reader__image", doc)].map(e => e.dataset.pageImageUrl),
        button: [4, "24%", 1],
        insertImg: [".imgBox", 2],
        go: 1,
        autoDownload: [0],
        ...
        prev: 1,
        customTitle: doc => fun.title(" - 漫畫狗", 0, doc),
        threading: 1,
        preloadNext: true,
        ...
        imgs: () => {
            ...
            return fun.arr(max).map((_, i) => {
                return fetch(`https://terra-historicus.hypergryph.com/api${location.pathname}/page?pageNum=${(i + 1)}`).then(res => res.json()).then(json => {
                    fun.showMsg(`${displayLanguage.str_06}${fetchNum+=1}/${max}`, 0);
        ...
        json: (doc = document) => {
            let code = [...doc.scripts].find(s => s.innerHTML.search(/x6c/) > -1).innerHTML.trim().slice(26);
        ...
        prev: "//a[text()='上一章']",
        customTitle: doc => fun.geT("#mangaTitle", 1, doc),
        ...
        enable: 0,
        reg: /((www|tw)\.manhuagui\.com)|www\.mhgui\.com\/comic\/\d+\/\d+.html|cocomanga\.xyz\/comic\/\d+\/\d+\.html/,
        init: "$(document).unbind('keydown');",
        imgs: (doc = document) => {
            let code = [...doc.scripts].find(s => s.innerHTML.search(/x6c/) > -1).innerHTML.slice(26, -1);
            let json = fun.run(fun.run(code).slice(11, -11));
            let domain;
            /manhuagui|mhgui/.test(location.host) ? domain = "https://i.hamreus.com" : domain = "https://i1.cocomanga.xyz";
        ...
        enable: 0,
        reg: /^https?:\/\/www\.cartoonmad\.com\/comic\/\d+\.html|^https?:\/\/cc\.fun8\.us\/post\/\d+\.html/,
        ...
        imgs: (link = siteUrl, msg = 1, request = 0) => {
            ...
            return fun.getImgA(".imgListBox img", links, 0, [null, null], msg, request);
        },
        button: [4],
        ...
        prev: ".display_left>a",
        customTitle: doc => fun.geT(".hotrmtexth1>a", 1, doc),
        preloadNext: true,
        ...
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'cInfo')]", 1, nextDoc);
            fun.script(code, 0, 1);
        ...
        customTitle: doc => {
            let code = fun.geT("//script[contains(text(),'jmzz20191018')]", 1, doc);
            let arr = code.match(/jmzz20191018\(([^\)]+)\)/)[1].replaceAll('"', "").split(",");
            return arr[3] + " - " + arr[1];
        },
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'chapterImages')]", 1, nextDoc);
            fun.script(code, 0, 1);
            jmzz20191018();
            fun.picPreload(obj.imgs(), obj.customTitle(nextDoc), "next");
            _0x5097 = null;
        ...
        enable: 0,
        reg: /^https?:\/\/(www|m)\.gufengmh\d?\.com\/manhua\/\w+\/\d+\.html/,
        init: () => {
            fun.run("$(document).off();");
            fun.remove("#skin");
        },
        ...
        customTitle: doc => {
            if (/^https?:\/\/www/.test(siteUrl)) {
                let arr = fun.geT(".title", 1, doc).split(" / ");
                return arr[0] + " - " + arr[1];
            } else {
                let code = fun.geT("//script[contains(text(),'SinMH.initChapter')]", 1, doc);
...
window.parent.postMessage({
    ...
    title: document.title
        ...
        button: [4],
        insertImg: ["#images", 2],
        insertImgAF: () => location.hostname == "www.gmh1234.com" && siteData.next() ? fun.addUrlHtml(siteData.next(), "#images", 1) : null,
        autoDownload: [0],
        ...
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'chapterImages')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(await obj.imgs(), nextDoc.title, "next");
        },
        css: ".globalPadding,.img_info,#imgLoading{display:none!important;}",
        category: "comic"
    }, {
        name: "92漫画",
        host: ["www.92mh.com"],
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => {
            let max = fun.geT(".image-content p", 1, doc).match(/\/(\d+)/)[1];
            return fun.getImg("#manga-image", max, 5, [null, null], 20, url, msg, request);
        },
        button: [4],
        insertImg: ["#images", 2],
        go: 1,
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => fun.getImg("#chapter-image img", fun.geT("#k_total", 1, doc), 5, [null, null], 20, url, msg, request),
        button: [4],
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => {
            let max = fun.geT(".image-content p", 1, doc).match(/\/(\d+)/)[1];
            return fun.getImg("#image", max, 5, [null, null], 20, url, msg, request);
        },
        button: [4],
        insertImg: ["#images", 2],
        go: 1,
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => {
            let max = Math.ceil(fun.geT("#images p", 1, doc).match(/\/(\d+)/)[1] / 3);
            return fun.getImg("#images img", max, 5, [null, null], 20, url, msg, request);
        },
        button: [4],
        insertImg: ["#images", 2],
        go: 1,
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => {
            let num = fun.geT("#images p", 1, doc).match(/\/(\d+)/)[1];
            let max = Math.ceil(num / 5);
            return location.hostname == "m.100mhl.com" ? fun.getImg("#images img", max, 5, [null, null], 20, url, msg, request) : fun.getImg("#images img", num, 5, [null, null], 20, url, msg, request);
        },
        button: [4],
        insertImg: ["#images", 2],
        go: 1,
        ...
        preloadNext: (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'picTree')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(obj.imgs(), obj.customTitle(nextDoc), "next");
        },
        ...
        customTitle: doc => fun.geT("#mangaTitle", 1, doc),
        preloadNext: (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'mhInfo')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(obj.imgs(), obj.customTitle(nextDoc), "next");
        },
        ...
        name: "漫画屋格式",
        host: ["www.mhua5.com", "www.mhw1.com", "www.cmh5.com", "www.360mh.cc", "www.manshiduo.net", "comics.veryim.com", "797mh.com", "www.biqug.org", "mh.9xxsm.com", "www.cuiman.com"],
        enable: 0,
        reg: /(www\.mhua5\.com|www\.mhw\d?\.com|www\.cmh5\.com|www\.360mh\.cc|mh\.9xxsm\.com)\/index\.php\/chapter\/\d+|(www\.manshiduo\.net|797mh\.com)\/chapter_\d+\.html|comics\.veryim\.com\/\w+\/\d+\/\d+\.html|www\.biqug\.org\/index\.php\/chapter-\d+.html|www\.cuiman\.com\/\d+-\d+\.html/i,
        include: ".rd-article-wr",
        init: "document.onkeydown=null;",
        ...
        next: () => {
            ...
            if (/797mh\.com|mh\.9xxsm\.com/.test(location.host)) {
        ...
        customTitle: doc => {
            ...
            } else if (/www\.cmh5\.com/.test(location.host)) {
                return fun.attr("meta[name=description]", "content", doc).split(" - 漫画屋")[0].replace("当前阅读的是", "").replace("的", " - ");
            } else if (/www\.360mh\.cc|797mh\.com|www\.biqug\.org|mh\.9xxsm\.com|www\.cuiman\.com/.test(location.host)) {
                return fun.geT(".j-comic-title", 1, doc) + " - " + fun.geT(".last-crumb", 1, doc);
            } else {
        ...
        name: "漫画屋M格式",
        host: ["m.mkzhan.com", "www.mhua5.com", "www.mhw1.com", "www.cmh5.com", "www.360mh.cc", "www.manshiduo.net", "797mh.com", "www.biqug.org", "mh.9xxsm.com", "m.cuiman.com"],
        enable: 0,
        reg: /m\.mkzhan\.com\/\d+\/\d+\.html|(www\.mhua5\.com|www\.mhw\d?\.com|www\.cmh5\.com|www\.360mh\.cc|mh\.9xxsm\.com)\/index\.php\/chapter\/\d+|(www\.manshiduo\.net|797mh\.com)\/chapter_\d+\.html|www\.biqug\.org\/index\.php\/chapter-\d+.html|m\.cuiman\.com\/\d+-\d+\.html/i,
        imgs: doc => fun.getImgSrcArr(".comic-page img,img[data-src],img[data-original]", doc),
        autoDownload: [0],
        next: async () => {
            if (/www\.mhua5\.com|www\.cmh5\.com|www\.360mh\.cc|www\.mhw\d\.com|www\.biqug\.org|mh\.9xxsm\.com|m\.cuiman\.com/.test(location.host)) {
            ...
            } else if (/www\.manshiduo\.net|www..cmh5\.com/.test(location.host)) {
                let next = fun.attr(".next-chapter", "_href");
                return next !== "" ? location.origin + next : null;
        ...
        prev: 1,
        customTitle: doc => {
            if (/www\.mhua5\.com|www\.cmh5\.com/.test(location.host)) {
                return fun.title(" - 漫画屋", 0, doc).replace("-", " - ");
            } else if (/m\.mkzhan\.com/.test(location.host)) {
                return fun.title(" - 漫客栈", 0, doc).trim();
            } else if (/www\.360mh\.cc|www\.mhw\d\.com|797mh\.com|www\.biqug\.org|mh\.9xxsm\.com|m\.cuiman\.com/.test(location.host)) {
                return shareArr[0].match(/《([^》]+)/)[1] + " - " + fun.geT(".comic-name", 1, doc);
            } else {
        ...
        next: "//a[text()='下一章'][contains(@href,'html')]",
        prev: "//a[text()='上一章'][contains(@href,'html')]",
        customTitle: (doc = document) => doc.title.split("漫画章节")[0] + " - " + fun.geT(".comic-name", 1, doc),
        preloadNext: true,
        category: "comic"
    }, {
        name: "vomic漫画",
        ...
        host: ["www.guoman.net"],
        enable: 1,
        reg: /www\.guoman\.net\/chapter\/.+\.html/i,
        imgs: ".main-item>img",
        button: [4, "24%", 1],
        ...
        customTitle: doc => fun.geT(".cartoon-title>a:first-child", 1, doc) + " - " + fun.geT(".cartoon-title>a:last-child", 1, doc),
        preloadNext: true,
        category: "comic"
    }, {
        name: "爱国漫M",
        host: ["m.guoman.net"],
        enable: 1,
        reg: /m\.guoman\.net\/chapter\/.+\.html/i,
        ...
        customTitle: doc => fun.title(" - ", 3, doc),
        preloadNext: (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'eval')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(obj.imgs(), obj.customTitle(nextDoc), "next");
        },
        category: "comic"
        ...
        include: "td img",
        comicListUrl: () => /(www|a|b)\.manmanju\.com/.test(location.origin) ? `http://www.manmanju.com/comiclist/${siteUrl.split("/")[4]}/index.htm` : `http://manhua.kukudm.com/comiclist/${siteUrl.split("/")[4]}/index.htm`,
        ...
        imgs: (doc = document) => {
            let code = [...doc.scripts].find(s => s.innerHTML.search(/eval/) > -1).innerHTML.match(/eval.+\)\)/)[0].slice(4);
        ...
        customTitle: doc => {
            let s = fun.geT(".info-title,.con_top", 1, doc).split(/\s?>/);
            return (s[2] + s[3]).trim();
        },
        preloadNext: async (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'imgs')]", 1, nextDoc);
            fun.script(code, 0, 1);
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => {
            let max = fun.geT("//a[text()='下一页']", 2, doc) || 1;
            return /www\.manhuag\.cc/.test(location.host) ? fun.getImg(".img img", max, 9, [null, null], 20, url, msg, request) : fun.getImg(".img img", max, 5, [null, null], 20, url, msg, request);
        },
        button: [4],
        ...
        imgs: (doc = document) => {
            let code = [...doc.scripts].find(s => s.innerHTML.search(/picTree/) > -1).innerHTML;
        ...
        enable: 0,
        reg: () => {
            let hosts = ["m.cocolamanhua.com", "cn.baozimh.one", "cocomanga.org", "baozimh.one", "bz.godamanga.art", "gd.godamanga.art", "cn.godamanga.art"];
            return hosts.includes(window.location.host) && /\/manga\/[a-z0-9-_]+\/[a-z0-9-_]+/.test(window.location.pathname) && fun.ge(".touch-manipulation img") ? true : false;
        },
        init: () => fun.remove("//div[ins[@class='adsbygoogle']]"),
        ...
        prev: "//a[text()='上一回']",
        customTitle: doc => {
            let [, , comic_name, comic_chapter] = fun.geT(".Reduction_left", 1, doc).split(" > ");
...
window.parent.postMessage({
    ...
    title: document.title
        ...
        preloadNext: (nextDoc, obj) => {
            let code = fun.geT("//script[contains(text(),'qTcms_S_m_murl_e')]", 1, nextDoc);
            fun.script(code, 0, 1);
            fun.picPreload(obj.imgs(), obj.customTitle(), "next");
        },
        category: "comic"
        ...
        init: () => fun.run("document.onkeydown=null;"),
        imgs: () => {
            try {
        ...
        go: 1,
        insertImgAF: () => siteData.next() ? fun.addUrlHtml(siteData.next(), ".tbCenter", 1) : null,
        autoDownload: [0],
        ...
        customTitle: doc => fun.geT("//a/span[@property and not(i)]", 1, doc) + " - " + fun.geT("//li/span[@property and not(i)]", 1, doc),
        preloadNext: true,
        category: "comic"
    }, {
        name: "砂之船动漫家",
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => {
            ...
            return fun.getImgA("#ComicPic", links, 100, [null, null], msg, request);
        },
        button: [4],
        ...
        prev: ".p.zhangjie",
        customTitle: doc => {
            let [, , comic_name, comic_chapter] = fun.geT(".b", 1, doc).split(" - ");
        ...
        imgs: (url = siteUrl, doc, msg = 1, request = 0) => {
            ...
            return fun.getImgA("#cpimg", links, 100, [null, null], msg, request);
        },
        button: [4],
        insertImg: ["#showimage", 2],
        autoDownload: [0],
        ...
        preloadNext: async (nextDoc, obj) => {
            const callback = (doc, fun) => {
                const code = `
window.parent.postMessage({
    iframePicArr: img_data_arr.map(e => is_webp && e.img_webp ? img_host + img_pre + e.img_webp : img_host + img_pre + e.img),
...
document.body.appendChild(text);
        ...
        host: ["binto.click"],
        reg: () => /^https?:\/\/binto\.click\/\w+$/i.test(siteUrl) && fun.ge("#go-link") ? true : false,
        init: async () => {
        ...
        init: async () => {
            ...
            if (lazyLoadFullResolution == 1) {
                const lazyLoad = () => {
                    [...document.querySelectorAll("img[src*='width=']")].forEach(item => {
                        //console.log(item);
            ...
            if (/\/collections\//.test(window.location.pathname) && lazyLoadSingleColumn == 1) {
            ...
            if (/\/models\//.test(window.location.pathname) && lazyLoadSingleColumn == 1) {
            ...
            if (/\/user\//.test(window.location.pathname) && lazyLoadSingleColumn == 1) {
            ...
            if (/\/search\//.test(window.location.pathname) && lazyLoadSingleColumn == 1) {
            ...
            if (/\?tags=/.test(window.location.search) && lazyLoadSingleColumn == 1) {
            ...
            if (/^\/(models|images|videos|posts)$/.test(window.location.pathname) && lazyLoadSingleColumn == 1) {
                fun.css(".mantine-63e7k9{display:block}.mantine-16xlp3a{width:100%;max-width:100%}.mantine-2r6b9p{margin:0px auto}");
                setInterval(() => {
                    if (/^\/(models|images|videos|posts)/.test(window.location.pathname)) {
                        let parentWidth = document.querySelector(".mantine-1hggcbg").style.width;
                        parentWidth == "" ? parentWidth = document.querySelector(".mantine-1hggcbg").offsetWidth : parentWidth = parseInt(parentWidth, 10);
                        [...document.querySelectorAll(".mantine-2r6b9p")].forEach(e => {
                            let img = e.querySelector("img.mantine-7aj0so,img.mantine-1f4qkyp");
            ...
            if (/^\/articles$/.test(window.location.pathname) && lazyLoadSingleColumn == 1) {
        ...
        init: async () => {
            ...
            if (lazyLoadFullResolution == 1) {
                ...
                const lazyLoad = () => {
                    setTimeout(() => {
                        [...gae("//a[div[div[img[contains(@src,'blob:')]]]][not(@data-src)][not(contains(@href,'video'))]")].forEach(aEle => {
    ...
    const _GM_xmlhttpRequest = (() => typeof GM_xmlhttpRequest != "undefined" ? GM_xmlhttpRequest : GM.xmlHttpRequest)();
    ...
    const fun = {
        ...
        getImg: async (img, maxPage = 1, mode = 1, rText = [null, null], time = 50, url = siteUrl, msg = 1, request = 0) => {
        ...
        getImgO: async (img, maxPage = 1, mode = 1, rText = [null, null], time = 200, replaceElement = null, url = siteUrl, msg = 1, request = 0) => {
            if (fun.ge(".FullPictureLoadImage") && request == 0) return [...fun.gae(".FullPictureLoadImage:not(.small)")];
            fetching = true;
        ...
        getImgA: async (img, link, mode = 0, rText = [null, null], showMsg = 1, request = 0) => { //從指定的所有鏈接抓圖片
            if (fun.ge(".FullPictureLoadImage") && request == 0) return [...fun.gae(".FullPictureLoadImage:not(.small)")];
            fetching = true;
            ...
            if (typeof link == "function") {
                ...
                links = [...new Set([...fun.gae(link)].map(a => a.href))];
        ...
        getImgCorsA: (img, a, time = 100) => {
            fetching = true;
            fun.showMsg(displayLanguage.str_01, 0);
            let xhrNum = 0;
            let links;
            typeof a === "string" ? links = [...fun.gae(a)].map(a => a.href) : links = a;
            let resArr = links.map(async (url, i, arr) => {
                await fun.delay(time * i, 0);
                return fun.xhrDoc(url).then(doc => {
                    fun.showMsg(`${displayLanguage.str_02}${xhrNum+=1}/${arr.length}`, 0);
                    return [...fun.gae(img, doc)];
                });
            });
            return Promise.all(resArr).then(arr => {
                fetching = false;
        ...
        getImgSrcArr: (img, doc = document) => {
            let imgs;
            typeof img === "string" ? imgs = [...fun.gae(img, doc)] : imgs = img;
            return imgs.map(ele => {
                let check = fun.checkImgSrc(ele);
        ...
        autoPager: async doc => {
            ...
            if (siteData.autoPager.stop) {
                let check;
                try {
                    check = await siteData.autoPager.stop(doc);
                } catch (error) {
            ...
            if (typeof siteData.autoPager.bF === "function") await siteData.autoPager.bF(doc);
            ...
            if (typeof siteData.autoPager.ele === "function" && siteData.autoPager.pos || typeof siteData.autoPager.ele === "string") {
                if (typeof siteData.autoPager.ele === "function") newEle = await siteData.autoPager.ele(doc);
                ...
                if (siteData.autoPager.showTitle !== 0) {
                    ...
                    if (typeof siteData.autoPager.title === "function") {
                        try {
                            titleText = await siteData.autoPager.title(doc);
        ...
        getNextLink: async doc => {
            if (typeof siteData.autoPager.next === "function") {
                let nextCode = await siteData.autoPager.next(doc);
            ...
            const loadImg = async (src, index) => {
                await new Promise(resolve => {
                    ...
                    temp.onerror = error => {
                        ...
                        if (!/e-hentai\.org|exhentai\.org/.test(location.host)) errorNum += 1;
                        if (/e-hentai\.org|exhentai\.org/.test(location.host)) resolve();
                        resolve();
                        setTimeout(() => {
                            if (/www\.yinghuamh\.net/.test(location.host)) {
        ...
        insertImg: (imgsArray, ele, mode = 1) => {
            ...
            if (siteData.button) {
                ...
                let width = "24%";
                if (typeof siteData.button[1] === "string") width = siteData.button[1];
                const buttonObj = [{
            ...
            if (srcArr.length > 0 || (srcArr.length >= 0 && videosSrcArray.length > 0)) {
                ...
                try {
                    if (typeof ele == "object") {
                        ...
                        if (typeof ele[2] == "string") fun.remove(ele[2]);
                    ...
                    if (typeof siteData.insertImgAF == "function") siteData.insertImgAF();
                } catch (error) {
        ...
        ge: (selector, domNode) => /^\//.test(selector) ? (domNode || document).evaluate(selector, (domNode || document), null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue : (domNode || document).querySelector(selector),
        gae: (selector, domNode) => {
            if (/^\//.test(selector)) {
                let nodes = [];
                let results = (domNode || document).evaluate(selector, (domNode || document), null, XPathResult.ANY_TYPE, null);
                let node;
        ...
        geT: (ele, mode = 1, doc = document) => {
            try {
                if (mode == 1) return fun.ge(ele, doc).innerText;
                if (mode == 2) return fun.ge(ele, doc).previousElementSibling.innerText;
                if (mode == 3) return fun.ge(ele, doc).previousElementSibling.previousElementSibling.innerText;
            } catch (error) {
                console.error("\nfun.geT() ERROR\n", error);
                return null;
            }
                ...
                if (entry.isIntersecting) {
                    ...
                    if (realSrc) {
                        ...
                        entry.target.onerror = async (error) => {
                            ...
                            if (/e-hentai\.org|exhentai\.org/.test(location.host)) {
                            ...
                            setTimeout(() => {
                                ...
                                } else if (/e-hentai\.org|exhentai\.org/.test(location.host)) {
        ...
        getKukudmSrc: async (url = siteUrl, doc = document, msg = 1) => {
            ...
            let resArr = links.map(url => {
                return fun.fetchDoc(url).then(doc => {
                    ...
                    let html = eval(script.replace("document.write(", "").replace(");", ""));
                    let dom = fun.doc(html);
                    let imgs = [...dom.images];
                    if (imgs.length > 1) {
                        return {
            ...
            try {
                if (typeof allSrc[0] === "string") {
                    ...
                    let obj = await fun.checkImgStatus(allSrc[0].src1, msg == 1 ? null : 0);
                    return obj.ok ? allSrc.map(e => e.src1) : allSrc.map(e => e.src2);
                }
            } catch (e) {
                return [];
            }
        },
        remove: (ele, time = 0) => setTimeout(() => [...fun.gae(ele)].forEach(e => e.remove()), time),
...
a[data-fancybox]:hover {
    ...
    if (lazyLoadFullResolution == undefined) {
        _GM_setValue("lazyLoadFullResolution", 0);
    ...
    let E_HENTAI_LoadOriginalImage = _GM_getValue("E_HENTAI_LoadOriginalImage");

    if (E_HENTAI_LoadOriginalImage == undefined) {
        E_HENTAI_LoadOriginalImage = 0;
    }
...
console.log("fancybox 3.5.7 選項物件",$.fancybox.defaults);
    ...
    for (let i = 0; i < customData.length; i++) {
        ...
        let check = false;
        try {
            if (typeof data.reg === "object") {
                check = data.reg.test(siteUrl);
            } else if (typeof data.reg === "function") {
            ...
            if (check) {
                ...
                if (next) {
                    ...
                    try {
                        if (link !== null) {
                            typeof link === "string" ? nextLink = link : null;
                            if (link.tagName == "A") {
                                try {
    ...
    if (showOptions) {
        unsafeWindow.FullPictureLoadCustomData = customData;
        //debug("\n圖片全載開啟了GM選單?\n", showOptions);
        ...
        try {
            if (nextLink && preloadNext && !downloading) {
                ...
                fun.fetchDoc(nextLink).then(async nextDoc => {
                    debug("\nnextDoc", nextDoc);
                    if (typeof preloadNext === "boolean" && preloadNext === true && typeof siteData.imgs === "function" && typeof siteData.customTitle === "function") {
                        fun.picPreload(await siteData.imgs(nextDoc), await siteData.customTitle(nextDoc), "next");
                    } else if (typeof preloadNext === "boolean" && preloadNext === true && typeof siteData.imgs === "string" && typeof siteData.customTitle === "function") {
                        let arr = fun.getImgSrcArr(siteData.imgs, nextDoc);
                        fun.picPreload(arr, await siteData.customTitle(nextDoc), "next");
                    } else if (typeof preloadNext == "function") {
