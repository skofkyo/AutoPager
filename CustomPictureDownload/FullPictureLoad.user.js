...
(async () => {
    ...
    let nextLink = null;
    const PCUA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 Edg/120.0.0.0";
    ...
    const customData = [{
        ...
        reg: /(pic\.yailay\.com|www\.kaizty\.com)\/(gallerys|articles|photos)\/(?!\?page=|\?m=|hot|top|tag)\w+\.html$|(www\.depvailon\.com|crimejunkiespodcast\.com)\/(?!\?page=|\?m=).+\.html$|nungvl\.net\/gallerys\/\d+\.cg$|lootiu\.com\/gallery\/.+\.cfg$|(pic\.yailay\.com|www\.kaizty\.com)\/(gallerys|articles|photos)\/(?!\?page=|\?m=|hot|top|tag)\w+\.html\?m=1$|www\.depvailon\.com\/(?!\?page=|\?m=).+\.html\?m=1$|nungvl\.net\/gallerys\/\d+\.cg\?m=1$|lootiu\.com\/gallery\/.+\.cfg\?m=1$|depday\.info\/v2\/\w+\.html|^https?:\/\/thismore\.fun\/view\/[^\.]+\.php|^https?:\/\/cosxuxi\.club\/[\w-]+\.html$/i,
        imgs: async () => {
            let max;
            try {
        ...
        host: ["www.xiuwo.net", "rmm8.com", "www.zanmm.com", "www.entuji.com", "www.mhgirl.com", "www.hutu6.com", "www.930tu.com", "www.930tp.com"],
        reg: /(www\.xiuwo\.net|rmm8\.com|www\.mhgirl\.com)\/tu([\w]+)?\/\d+\.html|www\.zanmm\.com\/tupian\/\d+\.html|(www\.entuji\.com|www\.hutu6\.com)\/\w+\/\d+\.html|www\.930t(u|p)\.com\/\w+\/\d+\.html/,
        init: () => fun.clearAllTimer(),
        ...
        name: "爱若传媒映画",
        host: ["www.inini.win"],
        reg: /^https?:\/\/www\.inini\.win\/\d+\/\d+\.html/,
        imgs: "article.post a",
        button: [4],
        insertImg: ["article.post", 2],
        customTitle: () => fun.title(" - 爱若传媒映画"),
        fancybox: {
            v: 3,
            css: false
        },
        ...
        reg: /(www\.(\d+tyu|\d+rty|\d+wer)\.com|sldlxz\.com|282471|284019\.xyz)\/e\/action\/ShowInfo\.php/i,
        ...
        name: "万德美图屋",
        host: ["www.wind5.com"],
        reg: () => /^https?:\/\/www\.wind5\.com\/tu\d+\.html$/.test(siteUrl) && fun.ge("#portfolio img") ? true : false,
        imgs: () => {
            let max;
            try {
        ...
        imgs: () => [...fun.gae(".left>.image img.lazy")].map(e => e.getAttribute("img") ?? e.src),
        button: [4],
        insertImg: [".left", 2],
        ...
        init: () => fun.clearAllTimer(),
        imgs: () => fun.getImg(".context img", fun.ge("a.last").href.split("/").at(-1), 7),
        button: [4],
        insertImg: [".context", 2],
        autoDownload: [0],
        next: ".post-previous a",
        ...
        name: "韩漫推荐",
        host: ["www.hanmantuijian.com"],
        reg: /^https?:\/\/www\.hanmantuijian\.com\/index\.php\/chapter\/\d+/,
...
window.parent.postMessage({
    ...
    title: document.title
        ...
        css: ".globalPadding{display:none!important;}",
        category: "comic"
    }, {
        name: "92漫画",
        host: ["www.92mh.com"],
        ...
        name: "爱国漫",
        host: ["www.kanguoman.com"],
        enable: 1,
        reg: /www\.kanguoman\.com\/chapter\/.+\.html/i,
        imgs: ".main-item>img",
        button: [4, "24%", 1],
        ...
        name: "爱国漫M",
        host: ["m.kanguoman.com"],
        enable: 1,
        reg: /m\.kanguoman\.com\/chapter\/.+\.html/i,
