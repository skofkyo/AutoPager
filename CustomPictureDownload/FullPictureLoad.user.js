...
(async () => {
    ...
    if (window.frameElement !== null || /iframe/i.test(window.name)) return; //腳本不在iframe框架裡運行
    ...
    const customData = [{
        ...
        autoPager: {
            ...
            re: ".pager",
            history: 1,
            title: doc => "Page " + fun.ge("li.current", doc).innerText
        },
        ...
        go: 1,
        customTitle: () => fun.title(" - ZzUp.Com"),
        category: "nsfw2"
    }, {
