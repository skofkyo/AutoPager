...
(async () => {
    ...
    try {
        _unsafeWindow = unsafeWindow;
    } catch (e) {
        _unsafeWindow = window;
    }
    ...
    const customData = [{
        ...
        next: ".article-nav-prev a",
        prev: ".article-nav-next a",
        customTitle: () => fun.gt(".entry-title").replace(/\d+p(\d+v)?$|\(\d+[\w\s\.\+-]+\)|\[\d+[\w\s\.\+-]+\]/i, "").trim(),
        fancybox: {
            v: 3,
            css: false
        },
        ...
        reg: () => /(www\.emonl\.com|www\.cybesx\.com)\/\d+\.html$/i.test(siteUrl) && fun.ge(".page-links") && !fun.ge(".read-point-box"),
        ...
        name: "柠檬皮",
        host: ["www.emonl.com", "www.cybesx.com"],
        reg: () => /(www\.emonl\.com|www\.cybesx\.com)\/\d+\.html$/i.test(siteUrl) && fun.ge(".single-content img") && !fun.ge(".read-point-box"),
        ...
        reg: () => /^https?:\/\/xxk222\.com\/artdetail\/\w+\.html/.test(siteUrl) && fun.ge("//strong[text()='美女美图']"),
        imgs: async () => {
        ...
        reg: () => /cosporn\.online\/.+\//.test(siteUrl) && fun.ge(".g1-content-narrow"),
        imgs: () => {
        ...
        name: "秀窝/RMM吧/赞MM/恩图集/美Girl图集/狐图网/930圖片網/爱秀美女/四魔写真",
        host: ["www.xiuwo.net", "rmm8.com", "www.zanmm.com", "www.entuji.com", "www.mhgirl.com", "www.hutu6.com", "www.930tu.com", "www.930tp.com", "wap.kunv.cc", "www.smkwan.com"],
        reg: [
        ...
        name: "gaidam18",
        host: ["gaidam18.com"],
        reg: () => /^https?:\/\/gaidam18\.com\/[^\/]+\/$/.test(siteUrl) && fun.ge("figure.gallery-item"),
        imgs: ".gallery-item img",
        button: [4],
        insertImg: [".gallery", 2],
        customTitle: () => fun.gt("h1.entry-title").replace("Ảnh sex ", "").replace(/\s?“[^”]+”/, "").trim(),
        ...
        name: "性趣套图/H漫画",
        host: ["myjkwd.com", "enpeta.com", "xjzi.top", "534798.xyz", "539765.xyz", "123548.xyz"],
        reg: () => /(myjkwd\.com|enpeta\.com|xjzi\.top|534798\.xyz|539765\.xyz|123548\.xyz)\/e\/action\/ShowInfo\.php/i.test(siteUrl) && fun.ge(".entry img"),
        ...
        name: "苍井优图",
        host: ["www.28tyu.com", "www.28rty.com", "www.28wer.com", "sldlxz.com", "www.yuxiangcao.com", "282471.xyz", "284019.xyz"],
        reg: /((www\.|a\.)(\d+tyu|\d+rty|\d+wer)\.com|sldlxz\.com|(www|a).yuxiangcao\.com|282471|284019\.xyz)\/e\/action\/ShowInfo\.php/i,
        ...
        name: "麻豆村/麻麻传媒/乌鸦传媒/糖心vlog/果冻传媒/兔子先生/中国X站/中国P站/麻豆101/麻豆吃瓜社区",
        host: ["www.madoucun.com", "www.madoucun.net", "www.mamamcn.com", "www.wuyamcn.com", "www.tangxvlog.com", "www.guodongmcn.com", "www.mrrabbit.org", "www.xvideo.bar", "www.proncn.com", "www.md101.tv", "www.mdcg.club"],
        ...
        imgs: () => {
            videosSrcArray = [...fun.gae(".video source[type='video/mp4']")].map(e => e.src);
            return [...fun.gae("div.img[data-src]")];
        },
        ...
        imgs: () => fun.getImgCorsA(".lightgallery img", "a[href*='/i/']"),
        button: [4],
        insertImg: [
            [".grid-images", 2], 2
        ],
        ...
        name: "HentaiFox圖片清單頁",
        host: ["hentaifox.com"],
        reg: () => /hentaifox\.com\/gallery\/\d+\/$/.test(siteUrl) && fun.ge(".view_group"),
        imgs: async () => {
            fun.showMsg(displayLanguage.str_04, 0);
...
window.parent.postMessage({
    ...
    title: document.title
        ...
        button: [4],
        insertImg: ["#images", 2],
        insertImgAF: () => fun.lh == "www.gmh1234.com" && siteData.next() ? fun.addUrlHtml(siteData.next(), "#images", 1) : null,
        autoDownload: [0],
        ...
        next: () => {
            ...
            if (/797mh\.com|mh\.9xxsm\.com/.test(fun.lh)) {
        ...
        customTitle: doc => {
            ...
            } else if (/www\.360mh\.cc|797mh\.com|www\.biqug\.org|mh\.9xxsm\.com|www\.cuiman\.com/.test(fun.lh)) {
        ...
        autoDownload: [0],
        next: async () => {
            if (/www\.mhua5\.com|www\.cmh5\.com|www\.360mh\.cc|www\.mhw\d\.com|www\.biqug\.org|mh\.9xxsm\.com|m\.cuiman\.com/.test(fun.lh)) {
        ...
        customTitle: doc => {
            ...
            } else if (/www\.360mh\.cc|www\.mhw\d\.com|797mh\.com|www\.biqug\.org|mh\.9xxsm\.com|m\.cuiman\.com/.test(fun.lh)) {
        ...
        imgs: () => msg.split("|").map(e => fun.lh.indexOf("m.77mh") != -1 ? ImgSvrList + e : img_qianz + e),
        button: [4],
        ...
        reg: () => {
            ...
            return hosts.includes(fun.lh) && /\/manga\/[a-z0-9-_]+\/[a-z0-9-_]+/.test(fun.lp) && fun.ge(".touch-manipulation img");
        },
    ...
    title: document.title
        ...
        imgs: () => {
            try {
                ...
                return _unsafeWindow.atob(qTcms_S_m_murl_e).split("$qingtiandy$");
            }
        },
        button: [4],
        ...
        prev: "//a[text()='上一章']",
        customTitle: () => {
            if (/www\.xuerenmanhua\.com|www\.52hah\.com|www\.kukanmanhua\.com/.test(fun.lh)) {
...
document.body.appendChild(text);
        ...
        init: async () => {
            ...
            if (fun.lh == "m.mhxqiu2.com") await fun.delay(600, 0);
        },
