...
(async () => {
    ...
    const customData = [{
        ...
        next: () => {
            ...
            return location.href.replace(/\d+$/, "") + (parseInt(num, 10) - 1);
        },
        ...
        name: "HOTGIRLchina格式",
        host: ["hotgirlchina.com", "thechinagirls.com", "theasiagirl.co", "manhsec.com", "sex4viet.com", "cutexinh.com", "girlxinhxinh.com", "asiaceleb.com"],
        ...
        */
        ...
        name: "Manhuagui看漫画",
        host: ["www.manhuagui.com", "tw.manhuagui.com"],
        enable: 0,
        ...
        name: "漫画吧M / 漫画连M",
        host: ["m.dmhua8.com", "m.100mhl.com"],
        enable: 0,
        ...
        name: "蔷薇漫画M/爱米推漫画M/下拉式漫画M/奇妙漫画M/冰氪漫画M/狗狗漫画M/奇奇漫画M/悠闲漫画M/不卡漫画M/多熙漫画M",
        host: ["m.qwmanhua.com", "m.imitui.com", "m.xlsmh.com", "m.qmiaomh.com", "m.icekr.com", "m.gougoumh.com", "m.qimhua.com", "m.yxtun.com", "m.bukamh.com", "m.duoximh.com"],
        enable: 0,
        ...
        name: "前未漫画/漫画芯/蔷薇漫画/最漫画/爱米推漫画/下拉式漫画/漫画吧/漫画连/拼拼漫画/零点漫画/雪儿漫画/狗狗漫画/奇奇漫画/悠闲漫画/不卡漫画/多熙漫画",
        host: ["www.qianmh.com", "www.mhxin.com", "www.qwmanhua.com", "www.zuimh.com", "www.imitui.com", "imitui.com", "www.xlsmh.com", "www.dmhua8.com", "www.100mhl.com", "www.pinmh.com", "www.0dmh.com", "www.xuermh.com", "www.gougoumh.com", "www.qimhua.com", "www.yxtun.com", "www.bukamh.com", "www.duoximh.com"],
        enable: 0,
        ...
        name: "漫画屋格式",
        host: ["www.mhua5.com", "www.mhw1.com", "www.manhw.com", "www.360mh.cc", "www.mhzj54.com", "www.bingmh.com", "www.manshiduo.net", "mh.manhw.com", "comics.veryim.com", "www.38manhua.com", "797mh.com"],
        enable: 0,
        ...
        name: "漫画屋M格式",
        host: ["www.mhua5.com", "www.manhw.com", "www.360mh.cc", "www.mhzj54.com", "www.bingmh.com", "www.manshiduo.net", "m.mkzhan.com", "mh.manhw.com", "www.mhw1.com", "www.38manhua.com", "797mh.com"],
        enable: 0,
        ...
        name: "漫画牛 / 漫画台",
        host: ["manhua666.cc", "www.manhua666.cc", "manhuatai.org", "www.manhuatai.org"],
        enable: 0,
        ...
        init: async () => {
            ...
            document.addEventListener("keydown", keyhidetoolbar);
            let api;
            /mangacopy/.test(location.origin) ? api = location.href.replace(/.*?(?=\/comic\/)/, "https://api.mangacopy.com/api/v3") : api = location.href.replace(/.*?(?=\/comic\/)/, "https://api.copymanga.site/api/v3");
            let json = await fetch(api).then(res => res.json());
            siteJson = json;
            debug("\n此頁JSON資料\n", json);
        },
    ...
    const fun = {
        getModeUrl: (mode, i) => {
            if (mode === 1) {
                ...
                //【 ==> ?page=2】第一頁 ==> 第二頁
                return siteUrl.replace(/\?page=\d+$/, "") + "?page=" + i;
            } else if (mode === 2) {
                //【.html ==> /2.html】 第一頁 ==> 第二頁
                return siteUrl.slice(0, -5) + "/" + i + ".html";
            } else if (mode === 3) {
                //【.html ==> _1.html】  第一頁 ==> 第二頁
                //return siteUrl.replace(/(_\d+)?\.html$/, "") + "_" + (i - 1) + ".html";
                return siteUrl.replace(/\.html$/, "") + "_" + (i - 1) + ".html";
            } else if (mode === 4) {
                //【/ ==> /2/】  第一頁 ==> 第二頁
                return siteUrl.slice(0, -1) + "/" + i + "/";
            } else if (mode === "4") {
                //【 ==> /2】  第一頁 ==> 第二頁
                return siteUrl + "/" + i;
            } else if (mode === 5) {
                //【.html ==> -2.html】  第一頁 ==> 第二頁
                return siteUrl.replace(/\.html$/, "") + "-" + i + ".html";
            } else if (mode === "5") {
                //【-1.html ==> -2.html】  第一頁 ==> 第二頁
                return siteUrl.replace(/(-\d+)?\.html$/, "") + "-" + i + ".html";
            } else if (mode === 6) {
                //【?p=1 ==> ?p=2】  第一頁 ==> 第二頁
                return siteUrl.replace(/\?p=\d+$/, "") + "?p=" + i;
            } else if (mode === 7) {
                //【/1 ==> /2】  第一頁 ==> 第二頁
                //【.html ==> .html/2】  第一頁 ==> 第二頁
                return siteUrl.replace(/\/\d+$/, "") + "/" + i;
            } else if (mode === 8) {
                //【 ==> &page=1】  第一頁 ==> 第二頁
                return siteUrl.replace(/&page=\d+$/, "") + "&page=" + (i - 1);
            } else if (mode === "8") {
                //【 ==> &page=2】  第一頁 ==> 第二頁
                return siteUrl.replace(/&page=\d+$/, "") + "&page=" + i;
            } else if (mode === 9) {
                //【.html ==> _2.html】  第一頁 ==> 第二頁
                return siteUrl.replace(/(_\d+)?\.html$/, "") + "_" + i + ".html";
            } else if (mode === 10) {
                //【.html ==> .html/2】  第一頁 ==> 第二頁
                return siteUrl.replace(/\.html(\/\d+)?$/, "") + ".html/" + i;
            } else if (mode === 11) {
                //【/ ==> /2.html】  第一頁 ==> 第二頁
                //【/1.html ==> /2.html】  第一頁 ==> 第二頁
                return siteUrl.replace(/\/(\d+\.html)?$/, "") + "/" + i + ".html";
                ...
                //【/ ==> /2.htm】  第一頁 ==> 第二頁
                //【/1.htm ==> /2.htm】  第一頁 ==> 第二頁
                return siteUrl.replace(/\/(\d+\.htm)?$/, "") + "/" + i + ".htm";
            } else if (mode === 13) {
                //【-1-* ==> -2-*】  第一頁 ==> 第二頁
                return siteUrl.replace(/-\d+-[^-]+$/, "") + "-" + i;
            } else if (mode === 14) {
                ...
                return siteUrl.replace(/\/(index(_\d+)?\.html)?$/, "") + "/index_" + i + ".html";
            } else if (mode === 16) {
                //【 ==> /2#list】  第一頁 ==> 第二頁
                return siteUrl.replace(/\/(index(_\d+)?\.html)?$/, "") + "/" + i + "#list";
            } else if (mode === 17) {
                //【.htm ==> _2.htm】  第一頁 ==> 第二頁
                return siteUrl.replace(/#$/, "").replace(/(_\d+)?\.htm$/, "") + "_" + i + ".htm";
            } else if (mode === 18) {
                //【/ ==> /page/2/】  第一頁 ==> 第二頁
                return siteUrl.replace(/\/(page\/\d+\/)?$/, "") + "/page/" + i + "/";
            } else if (mode === 19) {
